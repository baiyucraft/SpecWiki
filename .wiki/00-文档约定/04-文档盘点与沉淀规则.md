...
| `.docs/design/specwiki-contract-closure.md` 等 5 份 contract-closure program 设计 | 已完成迁移的历史设计入口 | 原稿随 parent change 保存在 `.spec/archive/**/research/source-designs/`；`.docs/design/**` 只保留迁移存根，稳定合同进入 Runtime、模块、CLI 与 capability 页面 |
