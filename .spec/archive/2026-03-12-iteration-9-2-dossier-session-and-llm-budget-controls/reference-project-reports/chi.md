...
LLM usage：requests=19, total_tokens=101845, page_research=15, page_enrichment=0
...
- 项目概述.md 被 42 个 reference 页面共享映射
...
- 专题/process/process-listarticles-flow-流程主题：ListArticles-flow.md (流程主题：ListArticles flow, 49 行)
...
- 专题/process/process-testsinglehandler-flow-流程主题：TestSingleHandler-flow.md (流程主题：TestSingleHandler flow, 25 行)
...
| 中间件系统/中间件链机制.md | 专题/root-mechanism/root-core-根级核心机制.md | 323/23 | 140/5 | 0/1 | 7/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：main.go、basic_auth.go、logger.go、logger_test.go、middleware.go、middleware_test.go、recoverer.go、recoverer_test.go |
...
| 中间件系统/自定义中间件开发.md | 专题/root-mechanism/root-core-根级核心机制.md | 351/23 | 121/5 | 0/1 | 5/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：context.go、basic_auth.go、get_head.go、logger.go、maybe.go、middleware.go、nocache.go、recoverer.go |
...
| 路由系统/基数树算法实现/插入算法实现.md | 专题/root-mechanism/root-core-根级核心机制.md | 375/23 | 283/5 | 16/1 | 9/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：context.go、pattern_test.go、tree_test.go |
...
| 路由系统/基数树算法实现/节点结构设计.md | 专题/root-mechanism/root-core-根级核心机制.md | 322/23 | 197/5 | 15/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：context.go、tree_test.go |
| 路由系统/基数树算法实现/路由模式解析.md | 专题/root-mechanism/root-core-根级核心机制.md | 357/23 | 229/5 | 16/1 | 9/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：context.go、mux_test.go、pattern_test.go、tree_test.go |
| 路由系统/子路由器系统/上下文传递机制.md | 专题/root-mechanism/root-core-根级核心机制.md | 313/23 | 209/5 | 19/1 | 9/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：main.go、context.go、context_test.go、logger.go、mux_test.go |
...
| 路由系统/路由匹配机制/动态参数提取.md | 专题/root-mechanism/root-core-根级核心机制.md | 291/23 | 108/5 | 0/1 | 4/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：main.go、context.go、context_test.go、path_value_test.go、pattern_test.go、tree_test.go |
| 路由系统/路由匹配机制/路由优先级规则.md | 专题/root-mechanism/root-core-根级核心机制.md | 250/23 | 114/5 | 0/1 | 5/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：context.go、mux_test.go、pattern_test.go、tree_test.go |
| 路由系统/路由匹配机制/路由匹配机制.md | 专题/root-mechanism/root-core-根级核心机制.md | 277/23 | 107/5 | 0/1 | 5/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：main.go、context.go、pattern_test.go、tree_test.go |
| 路由系统/路由匹配机制/路由匹配流程.md | 专题/root-mechanism/root-core-根级核心机制.md | 320/23 | 107/5 | 0/1 | 4/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：main.go、context.go、mux_test.go、pattern_test.go |
