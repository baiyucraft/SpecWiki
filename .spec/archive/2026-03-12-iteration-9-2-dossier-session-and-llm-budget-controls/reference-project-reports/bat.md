...
LLM usage：requests=33, total_tokens=146692, page_research=17, page_enrichment=0
...
- 专题/module-capability/module-f27a20dbbb7c-plugin-assets能力：扩展机制.md (assets能力：扩展机制, 32 行)
- 专题/process/process-build_static_mappings-flow-流程主题：build_static_mappings-flow.md (流程主题：build_static_mappings flow, 40 行)
...
- 核心模块/tests/syntax-tests.md (模块：syntax-tests, 61 行)
- 核心模块/tests/syntax-tests/highlighted.md (模块：highlighted, 55 行)
- 核心模块/tests/syntax-tests/highlighted/Requirements.txt.md (模块：Requirements.txt, 41 行)
- 核心模块/tests/syntax-tests/highlighted/nginx.md (模块：nginx, 40 行)
- 核心模块/tests/syntax-tests/source.md (模块：source, 63 行)
- 核心模块/tests/syntax-tests/source/Requirements.txt.md (模块：Requirements.txt, 41 行)
- 核心模块/tests/syntax-tests/source/nginx.md (模块：nginx, 40 行)
...
| 命令行接口参考/实用工具命令.md | 核心模块/src.md | 319/62 | 229/12 | 17/1 | 9/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：assets_metadata.rs、build_assets.rs、clap_app.rs、directories.rs、cache.rs |
| 命令行接口参考/配置管理选项.md | 核心模块/src.md | 398/62 | 145/12 | 0/1 | 7/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：.conf、assets_metadata.rs、clap_app.rs、config.rs、directories.rs、readme.md、theme.rs、bat-tabs.conf |
...
| 开发者指南/代码结构说明/核心模块详解/Assets 资源模块.md | 核心模块/src.md | 403/62 | 155/12 | 0/1 | 8/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：cargo.toml、list_syntaxes_and_themes.rs、assets_metadata.rs、build_assets.rs、acknowledgements.rs、lazy_theme_set.rs、serialized_syntax_set.rs、syntax_mapping.rs |
...
| 核心功能详解/语法高亮系统/语法文件管理.md | 核心模块/src.md | 357/62 | 119/12 | 17/1 | 6/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：cargo.toml、assets_metadata.rs、build_assets.rs、lazy_theme_set.rs、serialized_syntax_set.rs、syntax_mapping.rs、builtin.rs、metadata.yaml |
...
| 自定义与扩展/资源管理与打包.md | 核心模块/src.md | 336/62 | 134/12 | 0/1 | 7/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：cargo.toml、assets_metadata.rs、build_assets.rs、acknowledgements.rs、lazy_theme_set.rs、serialized_syntax_set.rs、metadata.yaml |
...
- Evidence：17 / 1
- Mermaid：9 / 1
- 文件提及重合：assets.rs、main.rs、app.rs
- reference 关键文件未覆盖：assets_metadata.rs、build_assets.rs、clap_app.rs、directories.rs、cache.rs
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：assets_metadata.rs、build_assets.rs、clap_app.rs、directories.rs、cache.rs
...
- Evidence：0 / 1
- Mermaid：7 / 1
- 文件提及重合：assets.rs、app.rs
- reference 关键文件未覆盖：.conf、assets_metadata.rs、clap_app.rs、config.rs、directories.rs、readme.md、theme.rs、bat-tabs.conf
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：.conf、assets_metadata.rs、clap_app.rs、config.rs、directories.rs、readme.md、theme.rs、bat-tabs.conf
...
- Mermaid：8 / 1
- 文件提及重合：assets.rs
- reference 关键文件未覆盖：cargo.toml、list_syntaxes_and_themes.rs、assets_metadata.rs、build_assets.rs、acknowledgements.rs、lazy_theme_set.rs、serialized_syntax_set.rs、syntax_mapping.rs
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：cargo.toml、list_syntaxes_and_themes.rs、assets_metadata.rs、build_assets.rs、acknowledgements.rs、lazy_theme_set.rs、serialized_syntax_set.rs、syntax_mapping.rs
...
- reference 关键文件未覆盖：cargo.toml、assets_metadata.rs、build_assets.rs、lazy_theme_set.rs、serialized_syntax_set.rs、syntax_mapping.rs、builtin.rs、metadata.yaml
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：cargo.toml、assets_metadata.rs、build_assets.rs、lazy_theme_set.rs、serialized_syntax_set.rs、syntax_mapping.rs、builtin.rs、metadata.yaml
...
- Evidence：0 / 1
- Mermaid：7 / 1
- 文件提及重合：main.rs、assets.rs
- reference 关键文件未覆盖：cargo.toml、assets_metadata.rs、build_assets.rs、acknowledgements.rs、lazy_theme_set.rs、serialized_syntax_set.rs、metadata.yaml
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：cargo.toml、assets_metadata.rs、build_assets.rs、acknowledgements.rs、lazy_theme_set.rs、serialized_syntax_set.rs、metadata.yaml
