...
LLM usage：requests=32, total_tokens=162450, page_research=18, page_enrichment=0

## 覆盖统计

- 专题页覆盖：generated 9 / reference 9
- evidence 落页：generated 13 / reference 47
- 图表达覆盖：generated 8 / reference 47
- page research 请求：18
- page enrichment 请求：0
- 已规划专题类型：流程主题(8)、专题页(1)
- 高频缺失专题：无
...
- 核心模块/ninja.md 被 24 个 reference 页面共享映射
- 专题/process/process-sync_view_wrapper-flow-流程主题：sync_view_wrapper-flow.md 被 3 个 reference 页面共享映射
- 专题/process/process-async_view_wrapper-flow-流程主题：async_view_wrapper-flow.md 被 3 个 reference 页面共享映射
- 专题/process/process-test_asyncio_operations-flow-流程主题：test_asyncio_operations-flow.md 被 2 个 reference 页面共享映射
...
- 专题/process/process-test_async_authenticate_method_in_sync_context-flow-流程主题：test_async_authenticate_method_in_sync_context-flow.md (流程主题：test_async_authenticate_method_in_sync_context flow, 33 行)
...
- 专题/process/process-test_sync_authenticate_method-flow-流程主题：test_sync_authenticate_method-flow.md (流程主题：test_sync_authenticate_method flow, 33 行)
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| API 参考/API 参考.md | 核心模块/ninja.md | 424/54 | 131/7 | 0/1 | 4/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：constants.py、decorators.py、pagination.py、responses.py、base.py、types.py |
...
| API 参考/核心 API 类.md | 核心模块/ninja.md | 521/54 | 246/7 | 0/1 | 7/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：conf.py、constants.py、decorators.py、utils.py、types.py、test_api_instance.py、test_router_add_router.py、test_router_defaults.py |
...
| API 参考/配置选项.md | 核心模块/ninja.md | 256/54 | 59/7 | 13/1 | 3/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：conf.py、constants.py、pagination.py、throttling.py、settings.py、test_conf.py、test_throttling.py、csrf.md |
| 快速开始.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
| 扩展与集成.md | 核心模块/ninja.md | 273/54 | 126/7 | 0/1 | 7/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：decorators.md、decorators.py、utils.py、pyproject.toml、test_add_decorator.py、test_add_decorator_async.py |
| 故障排除与常见问题.md | 核心模块/ninja.md | 260/54 | 111/7 | 21/1 | 7/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：bug_report.md、feature_request.md、contributing.md、readme.md、errors.md、help.md、settings.md、conf.py |
| 文档与规范.md | 核心模块/ninja.md | 331/54 | 129/7 | 0/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：api-docs.md、mkdocs.yml、conf.py、export_openapi_schema.py、swagger-ui-init.js、test_openapi_docs.py、openapi.js |
| 核心概念/NinjaAPI 实例管理.md | 核心模块/ninja.md | 323/54 | 117/7 | 20/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：conf.py、renderers.py、throttling.py、test_api_instance.py、openapi.js、ninja.conf |
| 核心概念/Operation 执行机制.md | 专题/process/process-sync_view_wrapper-flow-流程主题：sync_view_wrapper-flow.md | 408/67 | 162/46 | 0/1 | 8/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：decorators.py、operation.py、renderers.py、responses.py、details.py、utils.py、test_async.py、test_body.py |
| 核心概念/Router 路由系统/Router 路由系统.md | 专题/process/process-async_view_wrapper-flow-流程主题：async_view_wrapper-flow.md | 348/67 | 126/46 | 0/1 | 5/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：routers.md、urls.md、__init__.py、decorators.py、operation.py、test_api_instance.py、test_auth_inheritance_routers.py、test_inheritance_routers.py |
| 核心概念/Router 路由系统/URL 生成与命名.md | 专题/process/process-test_async_auth-flow-流程主题：test_async_auth-flow.md | 287/33 | 111/12 | 17/1 | 5/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：urls.md、operation.py、utils.py、test_api_instance.py、test_reverse.py、test_router_reuse.py |
| 核心概念/Router 路由系统/端点注册与装饰器.md | 专题/process/process-async_view_wrapper-flow-流程主题：async_view_wrapper-flow.md | 313/67 | 124/46 | 0/1 | 3/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：decorators.md、decorators.py、operation.py、utils.py、test_add_decorator.py、test_decorators.py |
| 核心概念/Router 路由系统/装饰器继承与传递.md | 专题/process/process-async_view_wrapper-flow-流程主题：async_view_wrapper-flow.md | 244/67 | 85/46 | 0/1 | 4/1 | 内容明显短于 reference；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：decorators.md、decorators.py、operation.py、utils.py、test_add_decorator.py、test_add_decorator_async.py、test_auth_inheritance_routers.py、test_inheritance_routers.py |
| 核心概念/Router 路由系统/路由创建与配置.md | 专题/process/process-test_asyncio_operations-flow-流程主题：test_asyncio_operations-flow.md | 305/23 | 99/5 | 0/1 | 3/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：routers.md、throttling.md、test_router_add_router.py、test_router_defaults.py、test_router_reuse.py、test_throttling.py |
| 核心概念/Router 路由系统/路由挂载与嵌套.md | 专题/process/process-test_asyncio_operations-flow-流程主题：test_asyncio_operations-flow.md | 327/23 | 115/5 | 0/1 | 4/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：routers.md、operation.py、test_inheritance_routers.py、test_router_add_router.py、test_router_defaults.py、test_router_path_params.py、test_router_reuse.py |
| 核心概念/Router 路由系统/路由构建与绑定.md | 专题/process/process-sync_view_wrapper-flow-流程主题：sync_view_wrapper-flow.md | 302/67 | 141/46 | 0/1 | 5/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：decorators.py、operation.py、test_api_instance.py、test_auth_inheritance_routers.py、test_inheritance_routers.py、test_router_add_router.py |
...
| 核心概念/装饰器系统.md | 核心模块/ninja.md | 293/54 | 119/7 | 0/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：decorators.md、decorators.py、utils.py、test_add_decorator.py、test_add_decorator_async.py、test_decorators.py |
...
| 输出处理/响应对象.md | 核心模块/ninja.md | 290/54 | 102/7 | 0/1 | 4/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：index.md、response-renderers.md、temporal_response.md、renderers.py、responses.py、test_response.py、test_response_cookies.py、test_response_multiple.py |
| 输出处理/响应渲染器.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
| 输出处理/数据序列化.md | 核心模块/ninja.md | 239/54 | 87/7 | 17/1 | 4/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：.js、renderers.py、responses.py、streaming.py、test_errors.py、test_response.py、test_serialization_context.py、config-pydantic.md |
| 输出处理/状态码处理.md | 核心模块/ninja.md | 260/54 | 93/7 | 0/1 | 4/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：errors.md、temporal_response.md、responses.py、test_status.py |
...
| 项目概述.md | 项目概述.md | 309/61 | 152/5 | 0/0 | 7/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：contributing.md、readme.md、motivation.md、__init__.py、conf.py、schema.py、pyproject.toml、urls.py |
...
| 高级功能/版本控制.md | 核心模块/ninja.md | 260/54 | 123/7 | 17/1 | 7/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：urls.md、versioning.md、export_openapi_schema.py、api.py、test_api_instance.py、test_openapi_extra.py、test_openapi_schema.py、test_reverse.py |
| 高级功能/限流机制.md | 专题/process/process-sync_view_wrapper-flow-流程主题：sync_view_wrapper-flow.md | 277/67 | 100/46 | 0/1 | 4/1 | 内容明显短于 reference；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：throttling.md、conf.py、errors.py、operation.py、throttling.py、test_throttling.py |
...
- Evidence：0 / 1
- Mermaid：4 / 0
- 文件提及重合：__init__.py、errors.py、main.py、schema.py、operation.py、router.py
- reference 关键文件未覆盖：constants.py、decorators.py、pagination.py、responses.py、base.py、types.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：constants.py、decorators.py、pagination.py、responses.py、base.py、types.py
...
- Evidence：0 / 1
- Mermaid：7 / 0
- 文件提及重合：__init__.py、errors.py、main.py、operation.py、router.py
- reference 关键文件未覆盖：conf.py、constants.py、decorators.py、utils.py、types.py、test_api_instance.py、test_router_add_router.py、test_router_defaults.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：conf.py、constants.py、decorators.py、utils.py、types.py、test_api_instance.py、test_router_add_router.py、test_router_defaults.py
...
- Evidence：13 / 1
- Mermaid：3 / 0
- 文件提及重合：errors.py、main.py
- reference 关键文件未覆盖：conf.py、constants.py、pagination.py、throttling.py、settings.py、test_conf.py、test_throttling.py、csrf.md
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：conf.py、constants.py、pagination.py、throttling.py、settings.py、test_conf.py、test_throttling.py、csrf.md
...
- Mermaid：7 / 0
- 文件提及重合：__init__.py、errors.py、main.py、operation.py、router.py
- reference 关键文件未覆盖：decorators.md、decorators.py、utils.py、pyproject.toml、test_add_decorator.py、test_add_decorator_async.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：decorators.md、decorators.py、utils.py、pyproject.toml、test_add_decorator.py、test_add_decorator_async.py
...
- Mermaid：7 / 0
- 文件提及重合：errors.py、main.py
- reference 关键文件未覆盖：bug_report.md、feature_request.md、contributing.md、readme.md、errors.md、help.md、settings.md、conf.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：bug_report.md、feature_request.md、contributing.md、readme.md、errors.md、help.md、settings.md、conf.py
...
- Evidence：0 / 1
- Mermaid：6 / 0
- 文件提及重合：main.py、docs.py、schema.py、urls.py、views.py
- reference 关键文件未覆盖：api-docs.md、mkdocs.yml、conf.py、export_openapi_schema.py、swagger-ui-init.js、test_openapi_docs.py、openapi.js
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：api-docs.md、mkdocs.yml、conf.py、export_openapi_schema.py、swagger-ui-init.js、test_openapi_docs.py、openapi.js
...
- Evidence：20 / 1
- Mermaid：6 / 0
- 文件提及重合：__init__.py、main.py、schema.py、urls.py、parser.py、router.py
- reference 关键文件未覆盖：conf.py、renderers.py、throttling.py、test_api_instance.py、openapi.js、ninja.conf
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：conf.py、renderers.py、throttling.py、test_api_instance.py、openapi.js、ninja.conf

### 核心概念/Operation 执行机制.md

- reference 标题：Operation 执行机制
- 生成页：专题/process/process-sync_view_wrapper-flow-流程主题：sync_view_wrapper-flow.md（流程主题：sync_view_wrapper flow）
- 匹配分数：130
- 页面类型：topic / topic
- 行数：408 / 67
- 段落行数：162 / 46
...
- 生成页：专题/process/process-test_asyncio_operations-flow-流程主题：test_asyncio_operations-flow.md（流程主题：test_asyncio_operations flow）
- 匹配分数：110
- 页面类型：topic / topic
- 行数：305 / 23
- 段落行数：99 / 5
...
- Mermaid：6 / 0
- 文件提及重合：main.py、operation.py、router.py
- reference 关键文件未覆盖：decorators.md、decorators.py、utils.py、test_add_decorator.py、test_add_decorator_async.py、test_decorators.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：decorators.md、decorators.py、utils.py、test_add_decorator.py、test_add_decorator_async.py、test_decorators.py
...
- reference 关键文件未覆盖：index.md、response-renderers.md、temporal_response.md、renderers.py、responses.py、test_response.py、test_response_cookies.py、test_response_multiple.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：index.md、response-renderers.md、temporal_response.md、renderers.py、responses.py、test_response.py、test_response_cookies.py、test_response_multiple.py
...
- Evidence：17 / 1
- Mermaid：4 / 0
- 文件提及重合：errors.py、main.py、schema.py
- reference 关键文件未覆盖：.js、renderers.py、responses.py、streaming.py、test_errors.py、test_response.py、test_serialization_context.py、config-pydantic.md
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：.js、renderers.py、responses.py、streaming.py、test_errors.py、test_response.py、test_serialization_context.py、config-pydantic.md
...
- Evidence：0 / 1
- Mermaid：4 / 0
- 文件提及重合：errors.py、main.py、operation.py
- reference 关键文件未覆盖：errors.md、temporal_response.md、responses.py、test_status.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：errors.md、temporal_response.md、responses.py、test_status.py
...
- Evidence：17 / 1
- Mermaid：7 / 0
- 文件提及重合：main.py、schema.py、router.py、urls.py
- reference 关键文件未覆盖：urls.md、versioning.md、export_openapi_schema.py、api.py、test_api_instance.py、test_openapi_extra.py、test_openapi_schema.py、test_reverse.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：urls.md、versioning.md、export_openapi_schema.py、api.py、test_api_instance.py、test_openapi_extra.py、test_openapi_schema.py、test_reverse.py
...
- 结论：内容明显短于 reference；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：throttling.md、conf.py、errors.py、operation.py、throttling.py、test_throttling.py
