...
1. UniSpec 状态会错误地告诉后续执行者“11.6 已完成，可以归档”。
...
- 让 README、UniSpec 和真实目录迁移目标重新对齐
...
- 单独检查注释是否符合 `.wiki/02-开发指南/00-代码注释规范.md`

## Risks / Trade-offs

- [风险：只改文档，不改任务状态]
  - 结果是 UniSpec 仍会把 change 标成已完成，继续误导 apply 与 archive
- [风险：只迁目录，不拆内部层次]
