...
- 重点影响已有规范：[`.wiki/05-规格基线/capabilities/repo-wiki-runtime/spec.md`](E:/project/!byAI/spec-wiki/.wiki/05-规格基线/capabilities/repo-wiki-runtime/spec.md)、[`.wiki/05-规格基线/capabilities/workflow-progress-streaming/spec.md`](E:/project/!byAI/spec-wiki/.wiki/05-规格基线/capabilities/workflow-progress-streaming/spec.md)、[`.wiki/05-规格基线/capabilities/codebuddy-agent-integration/spec.md`](E:/project/!byAI/spec-wiki/.wiki/05-规格基线/capabilities/codebuddy-agent-integration/spec.md)。
