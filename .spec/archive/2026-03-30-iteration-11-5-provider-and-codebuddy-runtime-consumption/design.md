...
- [`.wiki/06-设计文档/03-核心场景.md`](E:/project/!byAI/spec-wiki/.wiki/06-设计文档/03-核心场景.md) 场景 3、4 要求在改代码前先“找到入口、分析影响”。
- [`.wiki/06-设计文档/03-核心场景.md`](E:/project/!byAI/spec-wiki/.wiki/06-设计文档/03-核心场景.md) 场景 9 与 [`.wiki/06-设计文档/01-Runtime设计.md`](E:/project/!byAI/spec-wiki/.wiki/06-设计文档/01-Runtime设计.md) 又要求本地 runtime 恢复后能直接 `query`，并且 stale/missing 状态不能静默误导用户。
- [`.wiki/06-设计文档/04-扩展场景.md`](E:/project/!byAI/spec-wiki/.wiki/06-设计文档/04-扩展场景.md) 的 A1、A3、A9 也都在强调：新 Agent onboarding、索引/知识变旧、工具链失败时的降级状态，必须能被外部消费者稳定理解。
...
- `.wiki/06-设计文档/03-核心场景.md` 的找入口、看影响，都要求“结果可信且带理由”，不是只给一串 matches。
