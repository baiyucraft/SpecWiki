...
LLM usage：requests=17, total_tokens=74396, page_research=9, page_enrichment=2

## 覆盖统计

- 专题页覆盖：generated 13 / reference 3（repo-archetype=3）
- evidence 落页：generated 5 / reference 38
- citation 密度：generated 0.29 / reference 65.84
...
- 核心模块/cobra.md 被 20 个 reference 页面共享映射
- 专题/root-mechanism/root-core-根级核心机制.md 被 4 个 reference 页面共享映射
- 项目概述.md 被 8 个 reference 页面共享映射
...
- 专题/process/process-testnoargs_withvalid_withargs-flow-流程主题：TestNoArgs_WithValid_WithArgs-flow.md (流程主题：TestNoArgs_WithValid_WithArgs flow, 36 行)
...
- 专题/process/process-testnorootruncommandexecutedwithversionset-flow-流程主题：TestNoRootRunCommandExecutedWithVersionSet-flow.md (流程主题：TestNoRootRunCommandExecutedWithVersionSet flow, 36 行)
...
| 命令系统/钩子函数详解.md | 专题/root-mechanism/root-core-根级核心机制.md | 261/25 | 93/6 | 17/1 | 5/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、user_guide.md |
...
| 文档生成系统/Markdown 文档生成.md | 核心模块/cobra.md | 292/68 | 88/9 | 0/1 | 3/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：md_docs.go、md_docs_test.go、util.go、md.md |
| 文档生成系统/REST API 文档生成.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
...
| 标志系统/标志组管理.md | 核心模块/cobra.md | 269/68 | 104/9 | 0/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：completions_test.go、flag_groups.go、flag_groups_test.go、user_guide.md |
| 标志系统/标志继承机制.md | 专题/root-mechanism/root-core-根级核心机制.md | 234/25 | 97/6 | 0/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：user_guide.md |
...
| 核心概念/钩子函数机制.md | 专题/root-mechanism/root-core-根级核心机制.md | 211/25 | 85/6 | 0/1 | 4/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：user_guide.md |
...
| 高级特性/扩展机制.md | 专题/root-mechanism/root-core-根级核心机制.md | 235/25 | 78/6 | 0/1 | 4/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：util.go、user_guide.md |
