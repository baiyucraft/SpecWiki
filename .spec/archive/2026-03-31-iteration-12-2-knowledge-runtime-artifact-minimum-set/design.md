...
- `.wiki/.knowledge/**` 还没有最小正式对象集，因此 `.wiki/06-设计文档/01-Runtime设计.md` 里定义的 `.knowledge + pages + metadata + cache` 分层仍然只停留在概念上
- [.wiki/06-设计文档/03-核心场景.md](E:/project/!byAI/spec-wiki/.wiki/06-设计文档/03-核心场景.md) 的协作恢复场景还不成立：B 用户拉取 A 用户提交的 `.wiki` 后，不能仅凭 `.wiki/.knowledge/** + pages + metadata` 恢复本地 runtime
...
建议目录遵循 [.wiki/06-设计文档/01-Runtime设计.md](E:/project/!byAI/spec-wiki/.wiki/06-设计文档/01-Runtime设计.md) 的分层：
...
- 这条边界直接来自 [.wiki/06-设计文档/03-核心场景.md](E:/project/!byAI/spec-wiki/.wiki/06-设计文档/03-核心场景.md)
