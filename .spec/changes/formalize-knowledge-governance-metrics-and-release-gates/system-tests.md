# formalize-knowledge-governance-metrics-and-release-gates 系统测试用例
...
- 操作 / 触发: 运行 unispec status --json 或 unispec validate formalize-knowledge-governance-metrics-and-release-gates。
...
| 成功标准 | 系统测试用例 | 验证方式 |
| --- | --- | --- |
| UniSpec required artifact 完整 | ST-001 | unispec status --json / unispec validate formalize-knowledge-governance-metrics-and-release-gates |
...
- 当前仓库 .spec/changes/formalize-knowledge-governance-metrics-and-release-gates/。
- UniSpec CLI。
