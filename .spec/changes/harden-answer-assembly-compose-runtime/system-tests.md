# harden-answer-assembly-compose-runtime 系统测试用例
...
- 操作 / 触发: 运行 unispec status --json 或 unispec validate harden-answer-assembly-compose-runtime。
...
| 成功标准 | 系统测试用例 | 验证方式 |
| --- | --- | --- |
| UniSpec required artifact 完整 | ST-001 | unispec status --json / unispec validate harden-answer-assembly-compose-runtime |
...
- 当前仓库 .spec/changes/harden-answer-assembly-compose-runtime/。
- UniSpec CLI。
