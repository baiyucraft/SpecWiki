# iteration-12-9-2-derived-research-status-contract 系统测试用例
...
- 操作 / 触发: 运行 unispec status --json 或 unispec validate iteration-12-9-2-derived-research-status-contract。
...
| 成功标准 | 系统测试用例 | 验证方式 |
| --- | --- | --- |
| UniSpec required artifact 完整 | ST-001 | unispec status --json / unispec validate iteration-12-9-2-derived-research-status-contract |
...
- 当前仓库 .spec/changes/iteration-12-9-2-derived-research-status-contract/。
- UniSpec CLI。
