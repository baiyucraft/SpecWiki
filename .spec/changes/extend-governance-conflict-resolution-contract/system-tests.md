# extend-governance-conflict-resolution-contract 系统测试用例
...
- 操作 / 触发: 运行 unispec status --json 或 unispec validate extend-governance-conflict-resolution-contract。
...
| 成功标准 | 系统测试用例 | 验证方式 |
| --- | --- | --- |
| UniSpec required artifact 完整 | ST-001 | unispec status --json / unispec validate extend-governance-conflict-resolution-contract |
...
- 当前仓库 .spec/changes/extend-governance-conflict-resolution-contract/。
- UniSpec CLI。
