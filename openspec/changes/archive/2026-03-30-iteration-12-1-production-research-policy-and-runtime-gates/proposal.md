...
- 重点影响 OpenSpec 契约：`openspec/specs/research-driven-page-composition/spec.md`、`openspec/specs/wiki-llm-enhancement/spec.md`、`openspec/specs/repo-wiki-runtime/spec.md`、`openspec/specs/workflow-verification/spec.md`，以及新增 `production-research-policy` capability。
