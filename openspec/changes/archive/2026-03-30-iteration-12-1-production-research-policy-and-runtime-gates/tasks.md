...
- [x] 3.5 输出本轮 `storybook` 专项结论到 `openspec/changes/iteration-12-1-production-research-policy-and-runtime-gates/reference-project-reports/*.md`，并在结论中注明 `dagger` 延后到后续 change
