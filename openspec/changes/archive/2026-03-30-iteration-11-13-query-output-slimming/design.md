...
- [DESIGN-AGENTS.md](E:/project/!byAI/spec-wiki/DESIGN-AGENTS.md) 已明确 `v0.1.0` 宿主稳定消费应收敛在 `term / runtime_state / query_mode / query_trust / recommended_action / matched_pages / provenance_summary`
...
1. 先在 OpenSpec 中定义默认 query 外部 payload 的精简 contract
