...
- [x] 4.5 输出本轮 `storybook` 专项报告到 `openspec/changes/iteration-12-2-knowledge-runtime-artifact-minimum-set/reference-project-reports/*.md`，并把 `dagger` 作为观察项记录而不是主门禁
