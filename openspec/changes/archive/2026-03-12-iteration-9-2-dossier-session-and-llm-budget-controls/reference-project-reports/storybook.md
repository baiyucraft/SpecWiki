...
LLM usage：requests=35, total_tokens=239472, page_research=19, page_enrichment=0
...
- 专题/module-capability/module-eb98f4d9d066-library-core-webpack能力：扩展机制.md 被 6 个 reference 页面共享映射
- 核心模块/code/addons.md 被 9 个 reference 页面共享映射
- 专题/module-capability/module-b51ea519f0f1-library-codemod能力：扩展机制.md 被 3 个 reference 页面共享映射
- 核心模块/code/renderers.md 被 4 个 reference 页面共享映射
- 核心模块/code.md 被 8 个 reference 页面共享映射
- 核心模块/code/lib.md 被 3 个 reference 页面共享映射
- 核心模块/code/builders/builder-webpack5.md 被 6 个 reference 页面共享映射
- 核心模块/code/builders/builder-vite.md 被 2 个 reference 页面共享映射
...
- 专题/module-capability/module-3006222a09ec-entry-angular能力：入口编排.md (angular能力：入口编排, 51 行)
...
- 专题/module-capability/module-7351b0cc5a9b-library-csf-plugin能力：扩展机制.md (csf-plugin能力：扩展机制, 46 行)
- 专题/module-capability/module-7526a957f0fc-library-server-webpack能力：扩展机制.md (server-webpack能力：扩展机制, 48 行)
...
- 专题/module-capability/module-8182c18ba204-component-a11y能力：界面组成.md (a11y能力：界面组成, 62 行)
...
- 专题/module-capability/module-ca2e0a6d81e4-library-cli-sb能力：扩展机制.md (cli-sb能力：扩展机制, 33 行)
...
- 专题/module-capability/module-da1388cbf763-plugin-builder-webpack5能力：扩展机制.md (builder-webpack5能力：扩展机制, 102 行)
...
- 专题/module-capability/module-f16579f4c153-library-cli-storybook能力：扩展机制.md (cli-storybook能力：扩展机制, 61 行)
- 专题/module-capability/module-f183267d666d-plugin-builder-vite能力：扩展机制.md (builder-vite能力：扩展机制, 68 行)
- 专题/process/process-handleaddvalueadd-flow-流程主题：handleAddValueAdd-flow.md (流程主题：handleAddValueAdd flow, 35 行)
...
| API参考/类型定义参考/工具类型定义.md | 专题/module-capability/module-eb98f4d9d066-library-core-webpack能力：扩展机制.md | 296/53 | 172/31 | 16/1 | 6/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：root.ts、store.ts、hooks.ts、features.ts |
...
| 主题和外观/主题和外观.md | 专题/module-capability/module-b51ea519f0f1-library-codemod能力：扩展机制.md | 359/49 | 132/27 | 0/1 | 7/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：main.ts、manager.ts、preview.ts、storybook.setup.ts、styles.ts、story.ts、layout.test.ts、components.ts |
| 主题和外观/主题系统概览.md | 专题/module-capability/module-b51ea519f0f1-library-codemod能力：扩展机制.md | 302/49 | 113/27 | 0/1 | 6/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：manager.ts、preview.ts、api.md、theme-switcher.ts、base.ts、convert.ts、create.ts、convert.test.js |
| 主题和外观/布局和间距设计.md | 专题/module-capability/module-eb98f4d9d066-library-core-webpack能力：扩展机制.md | 185/53 | 64/31 | 0/1 | 3/1 | 内容明显短于 reference；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：filemock.js、fs-extra.ts、fs.ts、promises.ts、htmlmock.js、lodash-es.js、stylemock.js、uuid.js |
| 主题和外观/自定义主题开发.md | 专题/module-capability/module-eb98f4d9d066-library-core-webpack能力：扩展机制.md | 372/53 | 123/31 | 0/1 | 5/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、constants.ts、preview.ts、base.ts、convert.ts、create.ts、ensure.ts、dark.ts |
...
| 故障排除/故障排除.md | 核心模块/code.md | 348/252 | 106/169 | 0/1 | 6/2 | 章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、environments-support.ts、package.js、playwright.config.ts、tsconfig.js、vitest.config.ts、task.ts、options.ts |
| 故障排除/构建和性能问题.md | 核心模块/code/builders/builder-webpack5.md | 312/181 | 98/86 | 0/1 | 5/1 | 章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、vite-server.ts、file-cache.ts、utils.ts、bench-packages.ts、safe-args.ts、generate-bundle.ts |
...
| 核心概念/主题和参数系统.md | 专题/module-capability/module-eb98f4d9d066-library-core-webpack能力：扩展机制.md | 356/53 | 126/31 | 0/1 | 7/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：parameters.stories.ts、basic.stories.ts、constants.ts、helpers.ts、globalsstore.ts、getvaluesfromglobaltypes.ts、parameters.ts、convert.ts |
...
| 测试框架/可访问性测试.md | 核心模块/code/lib/core-webpack.md | 300/107 | 109/35 | 0/1 | 5/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、a11yrunner.ts、a11yrunnerutils.ts、constants.ts、manager.ts、params.ts、preview.ts、utils.ts |
...
| 项目概述/技术架构/构建系统架构/Vite构建器.md | 核心模块/code/builders/builder-vite.md | 283/130 | 127/50 | 0/1 | 7/1 | 解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、preset.js、build.ts、codegen-modern-iframe-script.ts、preset.ts、vite-config.ts、vite-server.ts、vite.conf |
...
| 项目概述/技术架构/框架适配器架构/Angular框架适配器.md | 专题/module-capability/module-eb98f4d9d066-library-core-webpack能力：扩展机制.md | 355/53 | 245/31 | 17/1 | 8/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、package.js、error-handler.ts、run-compodoc.ts、standalone-options.ts、preset.ts、framework-preset-angular-cli.ts、framework-preset-angular-ivy.ts |
...
- reference 标题：工具类型定义
- 生成页：专题/module-capability/module-eb98f4d9d066-library-core-webpack能力：扩展机制.md（core-webpack能力：扩展机制）
- 匹配分数：66
- 页面类型：other / topic
- 行数：296 / 53
- 段落行数：172 / 31
- Evidence：16 / 1
- Mermaid：6 / 1
- 文件提及重合：types.ts、index.ts
- reference 关键文件未覆盖：root.ts、store.ts、hooks.ts、features.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：root.ts、store.ts、hooks.ts、features.ts
...
- Mermaid：5 / 1
- 文件提及重合：index.ts、types.ts
- reference 关键文件未覆盖：package.js、constants.ts、preview.ts、base.ts、convert.ts、create.ts、ensure.ts、dark.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、constants.ts、preview.ts、base.ts、convert.ts、create.ts、ensure.ts、dark.ts
...
- Evidence：0 / 1
- Mermaid：8 / 1
- 文件提及重合：build-config.ts、project.js、index.ts、types.ts
...
- Mermaid：7 / 1
- 文件提及重合：types.ts
- reference 关键文件未覆盖：parameters.stories.ts、basic.stories.ts、constants.ts、helpers.ts、globalsstore.ts、getvaluesfromglobaltypes.ts、parameters.ts、convert.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：parameters.stories.ts、basic.stories.ts、constants.ts、helpers.ts、globalsstore.ts、getvaluesfromglobaltypes.ts、parameters.ts、convert.ts
...
- reference 标题：可访问性测试
- 生成页：核心模块/code/lib/core-webpack.md（模块：core-webpack）
- 匹配分数：92
- 页面类型：other / module
- 行数：300 / 107
- 段落行数：109 / 35
...
- Mermaid：5 / 1
- 文件提及重合：index.ts、types.ts
- reference 关键文件未覆盖：package.js、a11yrunner.ts、a11yrunnerutils.ts、constants.ts、manager.ts、params.ts、preview.ts、utils.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、a11yrunner.ts、a11yrunnerutils.ts、constants.ts、manager.ts、params.ts、preview.ts、utils.ts
...
- 结论：解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、preset.js、build.ts、codegen-modern-iframe-script.ts、preset.ts、vite-config.ts、vite-server.ts、vite.conf
...
- Mermaid：8 / 1
- 文件提及重合：build-config.ts、project.js、index.ts、types.ts
- reference 关键文件未覆盖：readme.md、package.js、error-handler.ts、run-compodoc.ts、standalone-options.ts、preset.ts、framework-preset-angular-cli.ts、framework-preset-angular-ivy.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、package.js、error-handler.ts、run-compodoc.ts、standalone-options.ts、preset.ts、framework-preset-angular-cli.ts、framework-preset-angular-ivy.ts
