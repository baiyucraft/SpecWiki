...
LLM usage：requests=17, total_tokens=74598, page_research=10, page_enrichment=0

## 覆盖统计

- 专题页覆盖：generated 9 / reference 2
...
- 核心模块/httpx.md 被 22 个 reference 页面共享映射
- 项目概述.md 被 4 个 reference 页面共享映射

## 额外生成页面

- 专题/process/process-async_auth_flow-flow-流程主题：async_auth_flow-flow.md (流程主题：async_auth_flow flow, 54 行)
- 专题/process/process-handle_async_request-flow-流程主题：handle_async_request-flow.md (流程主题：handle_async_request flow, 34 行)
- 专题/process/process-handle_help-flow-流程主题：handle_help-flow.md (流程主题：handle_help flow, 20 行)
- 专题/process/process-handle_request-flow-流程主题：handle_request-flow.md (流程主题：handle_request flow, 20 行)
- 专题/process/process-sync_auth_flow-flow-流程主题：sync_auth_flow-flow.md (流程主题：sync_auth_flow flow, 54 行)
- 专题/process/process-test_async_digest_auth_raises_protocol_error_on_malformed_header-flow-流程主题：test_async_digest_auth_raises_protocol_error_on_malformed_header-flow.md (流程主题：test_async_digest_auth_raises_protocol_error_on_malformed_header flow, 20 行)
- 专题/process/process-test_cannot_stream_sync_request-flow-流程主题：test_cannot_stream_sync_request-flow.md (流程主题：test_cannot_stream_sync_request flow, 34 行)
...
| 协议支持/WSGI_ASGI集成.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
| 协议支持/传输层架构.md | 系统架构.md | 372/35 | 152/4 | 0/1 | 8/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：transports.md、_client.py、asgi.py、base.py、default.py、mock.py、wsgi.py、test_asgi.py |
...
| 核心API参考/数据模型API/URL模型.md | 核心模块/httpx.md | 350/53 | 159/7 | 0/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：_exceptions.py、_utils.py、test_url.py、whatwg.js、_init__.py |
| 核心API参考/数据模型API/头部与Cookie模型.md | 核心模块/httpx.md | 301/53 | 140/7 | 0/1 | 8/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：quickstart.md、_types.py、test_cookies.py、test_headers.py |
| 核心API参考/数据模型API/数据模型API.md | 核心模块/httpx.md | 364/53 | 160/7 | 0/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、_types.py、test_cookies.py、test_headers.py、test_requests.py、test_responses.py、test_url.py |
| 核心API参考/数据模型API/请求与响应模型/Request请求模型.md | 核心模块/httpx.md | 314/53 | 116/7 | 0/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：compatibility.md、_content.py、_multipart.py、_types.py、test_cookies.py、test_requests.py、test_multipart.py |
| 核心API参考/数据模型API/请求与响应模型/Response响应模型.md | 专题/process/process-main-flow-流程主题：main-flow.md | 287/32 | 90/14 | 15/1 | 3/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：_content.py、_decoders.py、_exceptions.py、_models.py、_status_codes.py、test_redirects.py、test_responses.py |
...
| 配置管理.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
| 错误处理.md | 核心模块/httpx.md | 352/53 | 140/7 | 17/1 | 7/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：authentication.md、proxies.md、timeouts.md、exceptions.md、logging.md、quickstart.md、troubleshooting.md、_exceptions.py |
...
| 项目概述/技术架构概览.md | 核心模块/httpx.md | 367/53 | 162/7 | 16/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、_config.py、_exceptions.py、asgi.py、base.py、default.py、mock.py、wsgi.py |
| 项目概述/项目介绍和特性.md | 项目概述.md | 295/54 | 135/5 | 0/0 | 7/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：test-suite.yml、readme.md、async.md、compatibility.md、http2.md、index.md、quickstart.md、_api.py |
...
| 高级功能/认证机制.md | 专题/module-capability/module-0e432e69ba44-library-httpx能力：扩展机制.md | 299/24 | 141/5 | 0/1 | 9/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：authentication.md、__init__.py、_models.py、test_auth.py |
...
- Evidence：0 / 1
- Mermaid：6 / 0
- 文件提及重合：__init__.py、_models.py、_urlparse.py、_urls.py
- reference 关键文件未覆盖：_exceptions.py、_utils.py、test_url.py、whatwg.js、_init__.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：_exceptions.py、_utils.py、test_url.py、whatwg.js、_init__.py
...
- Mermaid：8 / 0
- 文件提及重合：__init__.py、_client.py、_models.py
- reference 关键文件未覆盖：quickstart.md、_types.py、test_cookies.py、test_headers.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：quickstart.md、_types.py、test_cookies.py、test_headers.py
...
- Evidence：0 / 1
- Mermaid：6 / 0
- 文件提及重合：_models.py、_urlparse.py、_urls.py
- reference 关键文件未覆盖：readme.md、_types.py、test_cookies.py、test_headers.py、test_requests.py、test_responses.py、test_url.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、_types.py、test_cookies.py、test_headers.py、test_requests.py、test_responses.py、test_url.py
...
- reference 关键文件未覆盖：compatibility.md、_content.py、_multipart.py、_types.py、test_cookies.py、test_requests.py、test_multipart.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：compatibility.md、_content.py、_multipart.py、_types.py、test_cookies.py、test_requests.py、test_multipart.py
...
- Mermaid：3 / 1
- 文件提及重合：__init__.py
- reference 关键文件未覆盖：_content.py、_decoders.py、_exceptions.py、_models.py、_status_codes.py、test_redirects.py、test_responses.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：_content.py、_decoders.py、_exceptions.py、_models.py、_status_codes.py、test_redirects.py、test_responses.py
...
- Mermaid：6 / 0
- 文件提及重合：__init__.py、_api.py、_client.py、_models.py、_urls.py
- reference 关键文件未覆盖：readme.md、_config.py、_exceptions.py、asgi.py、base.py、default.py、mock.py、wsgi.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、_config.py、_exceptions.py、asgi.py、base.py、default.py、mock.py、wsgi.py
...
- reference 标题：认证机制
- 生成页：专题/module-capability/module-0e432e69ba44-library-httpx能力：扩展机制.md（httpx能力：扩展机制）
- 匹配分数：142
- 页面类型：topic / topic
- 行数：299 / 24
- 段落行数：141 / 5
- Evidence：0 / 1
- Mermaid：9 / 0
- 文件提及重合：_auth.py、_client.py
- reference 关键文件未覆盖：authentication.md、__init__.py、_models.py、test_auth.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：authentication.md、__init__.py、_models.py、test_auth.py
