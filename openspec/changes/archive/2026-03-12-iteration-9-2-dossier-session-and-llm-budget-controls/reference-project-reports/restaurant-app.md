...
LLM usage：requests=28, total_tokens=177000, page_research=12, page_enrichment=0

## 覆盖统计

- 专题页覆盖：generated 16 / reference 0
- evidence 落页：generated 30 / reference 127
- 图表达覆盖：generated 26 / reference 127
- page research 请求：12
- page enrichment 请求：0
- 已规划专题类型：专题页(10)、流程主题(6)
- 高频缺失专题：无
...
- 核心模块/src/backend/services.md 被 5 个 reference 页面共享映射
- 核心模块/src/backend/services/catalog-api.md 被 4 个 reference 页面共享映射
- 核心模块/src/backend/services/web.admin.md 被 4 个 reference 页面共享映射
- 核心模块/src/backend/services/web.admin/dashboard-app.md 被 14 个 reference 页面共享映射
- 系统架构.md 被 33 个 reference 页面共享映射
- 工作流与部署.md 被 14 个 reference 页面共享映射
- 专题/module-capability/module-b956eb7f2423-service-dashboard-app能力：服务协作.md 被 6 个 reference 页面共享映射
- 项目概述.md 被 5 个 reference 页面共享映射

## 额外生成页面

- 专题/module-capability/module-48423669fc7c-service-manifests能力：服务协作.md (manifests能力：服务协作, 24 行)
- 专题/module-capability/module-4bf92bb05517-service-web.admin能力：服务协作.md (web.admin能力：服务协作, 24 行)
- 专题/module-capability/module-55d3428a6f12-service-services能力：服务协作.md (services能力：服务协作, 32 行)
- 专题/module-capability/module-5f11b0ec8bcc-service-checkout-api能力：服务协作.md (checkout-api能力：服务协作, 39 行)
- 专题/module-capability/module-7664ec0cbf9c-service-catalog-api能力：服务协作.md (catalog-api能力：服务协作, 33 行)
- 专题/module-capability/module-826359ff36b2-service-dashboard能力：服务协作.md (dashboard能力：服务协作, 37 行)
- 专题/module-capability/module-b9d0ca451eea-service-web-app能力：服务协作.md (web-app能力：服务协作, 40 行)
...
- 核心模块/src/backend/services/web.admin/dashboard.md (模块：dashboard, 95 行)
...
| API接口文档/REST API规范/目录API端点.md | 核心模块/src/backend/services/catalog-api.md | 326/77 | 92/15 | 0/1 | 3/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：catalog-api.postman_collection.js、schema.rs |
...
| 前端应用架构/Web应用（Next.js）/应用架构设计.md | 核心模块/src/backend/services/web-app.md | 282/89 | 133/22 | 0/1 | 8/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：next.config.js、package.js、postcss.config.js、providers.ts、instrumentation.node.ts、middleware.ts、tailwind.config.ts、next.js |
...
| 前端应用架构/Web应用（Next.js）/组件系统.md | 系统架构.md | 299/74 | 134/16 | 0/1 | 5/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：next.config.js、package.js、page.ts、layout.ts、actions.ts、cart-detail.ts、cart-item.ts、open-cart.ts |
...
| 前端应用架构/Web管理后台（Angular）/Web管理后台（Angular）.md | 系统架构.md | 194/74 | 92/16 | 0/1 | 5/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、angular.js、package.js、app.module.ts、app.router.ts、shared.module.ts |
...
| 前端应用架构/Web管理后台（Angular）/传统Angular仪表板/订单监控模块.md | 核心模块/src/backend/services/web.admin/dashboard-app.md | 320/80 | 224/16 | 17/1 | 8/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：orderscontroller.java、checkout-completed.ts、order.ts、order-table-row.ts |
...
| 前端应用架构/前端应用架构.md | 核心模块/src/backend/services/web.admin.md | 332/69 | 152/14 | 0/1 | 6/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：next.config.js、package.js、index.ts、layout.ts、providers.ts、tailwind.config.ts、angular.js、auth.guard.ts |
...
| 开发者指南/CI_CD流水线/容器化CI_CD.md | 核心模块/src/backend/services/web.admin/dashboard-app.md | 305/80 | 137/16 | 0/1 | 10/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：azure-pipelines.yml、grafana.yaml、prometheus.yaml、deployment.yaml、http-route.yaml、service.yaml、docker-compose.yml |
| 开发者指南/CI_CD流水线/移动应用CI_CD.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
| 开发者指南/代码贡献流程.md | 专题/module-capability/module-b956eb7f2423-service-dashboard-app能力：服务协作.md | 294/32 | 99/10 | 14/1 | 8/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：action.yml、cart-api.yml、checkout-api.yml、order-api.yml、payment-api.yml、web-app.yml、.gitpod.yml、contributing.md |
| 开发者指南/开发最佳实践/代码质量保证.md | 专题/module-capability/module-b956eb7f2423-service-dashboard-app能力：服务协作.md | 384/32 | 122/10 | 20/1 | 8/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：.gitpod.yml、.rustfmt.toml、azure-pipelines.yml、cargo.toml、package.js、tslint.js、prettier.config.js |
...
| 开发者指南/开发最佳实践/容器化与DevOps.md | 核心模块/src/backend/services/web.admin/dashboard-app.md | 365/80 | 158/16 | 0/1 | 8/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、azure-pipelines.yml、kafka-stateful-set.yaml、grafana.yaml、prometheus.yaml、deployment.yaml、http-route.yaml、service.yaml |
| 开发者指南/开发最佳实践/开发工具与调试.md | 核心模块/src/backend/services/web.admin/dashboard-app.md | 401/80 | 177/16 | 0/1 | 8/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：cart-api.postman_collection.js、catalog-api.postman_collection.js、checkout-api.postman_collection.js、local-docker.postman_environment.js、docker-compose.override.yml、docker-compose.yml、main.go、instrumentation.go |
| 开发者指南/开发最佳实践/开发最佳实践.md | 核心模块/src/backend/services/web.admin/dashboard-app.md | 349/80 | 155/16 | 0/1 | 7/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：contributing.md、readme.md、azure-pipelines.yml、kustomization.yaml、docker-compose.yml、cargo.toml、package.js、apinode.js |
| 开发者指南/开发最佳实践/微服务设计原则.md | 核心模块/src/backend/services/web.admin/dashboard-app.md | 332/80 | 147/16 | 0/1 | 8/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、deployment.yaml、cart_handler.go、cargo.toml、main.rs、package.js、index.ts、main.go |
...
| 开发者指南/开发环境配置/Docker容器化配置/微服务Dockerfile配置.md | 专题/module-capability/module-b956eb7f2423-service-dashboard-app能力：服务协作.md | 450/32 | 167/10 | 24/1 | 11/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：cargo.toml、index.js、package.js |
| 开发者指南/开发环境配置/Docker容器化配置/数据持久化与卷管理.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
| 开发者指南/开发环境配置/IDE开发工具配置/IDE开发工具配置.md | 专题/module-capability/module-b956eb7f2423-service-dashboard-app能力：服务协作.md | 426/32 | 182/10 | 21/1 | 9/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：.rustfmt.toml、cargo.toml、package.js、tsconfig.js、tslint.js、prettier.config.js、tailwind.config.ts |
| 开发者指南/开发环境配置/IDE开发工具配置/IntelliJ IDEA配置.md | 专题/module-capability/module-b956eb7f2423-service-dashboard-app能力：服务协作.md | 318/32 | 110/10 | 16/1 | 7/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：.rustfmt.toml、cargo.toml、package.js、tsconfig.js、prettier.config.js、package-lock.js |
...
| 开发者指南/开发环境配置/Vagrant虚拟机配置.md | 核心模块/src/backend/services/web.admin/dashboard-app.md | 294/80 | 210/16 | 14/1 | 7/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：.gitpod.yml、contributing.md、readme.md |
...
| 开发者指南/开发环境配置/本地环境搭建.md | 核心模块/src/backend/services/web.admin/dashboard-app.md | 358/80 | 127/16 | 0/1 | 3/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：contributing.md、readme.md、docker-compose.override.yml、docker-compose.yml、cargo.toml、main.rs、package.js、index.ts |
| 开发者指南/开发者指南.md | 核心模块/src/backend/services/web.admin/dashboard-app.md | 352/80 | 170/16 | 0/1 | 9/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：.gitpod.yml、contributing.md、readme.md、azure-pipelines.yml、docker-compose.yml、cargo.toml、package.js |
| 开发者指南/调试与故障排除/开发环境调试.md | 核心模块/src/backend/services/web.admin/dashboard-app.md | 407/80 | 199/16 | 0/1 | 8/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、docker-compose.override.yml、docker-compose.yml、cargo.toml、main.rs、package.js、index.ts、main.go |
| 开发者指南/调试与故障排除/性能问题诊断.md | 专题/module-capability/module-b956eb7f2423-service-dashboard-app能力：服务协作.md | 406/32 | 168/10 | 0/1 | 9/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：grafana.yaml、otel-collector.yaml、prometheus.yaml、docker-compose.otel.yml、performance-test-dasboard.js、datasource.yaml、db.go、cargo.toml |
| 开发者指南/调试与故障排除/服务间通信调试.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
| 开发者指南/调试与故障排除/生产环境故障排除.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
| 开发者指南/调试与故障排除/调试与故障排除.md | 核心模块/src/backend/services/web.admin/dashboard-app.md | 395/80 | 114/16 | 0/1 | 4/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、basket-api.postman_collection.js、cart-api.postman_collection.js、catalog-api.postman_collection.js、checkout-api.postman_collection.js、local-docker.postman_environment.js、docker-compose.kafka.yml、docker-compose.otel.yml |
...
| 快速开始.md | 核心模块/src/backend/services/web.admin/dashboard-app.md | 297/80 | 89/16 | 0/1 | 3/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：.gitpod.yml、readme.md、kustomization.yaml、deployment.yaml、local-docker.postman_environment.js、docker-compose.override.yml、docker-compose.yml、main.rs |
| 性能优化/前端性能优化.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
| 性能优化/微服务性能优化.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
| 性能优化/性能优化.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
| 性能优化/监控与指标收集.md | 核心模块/src/backend/services/web.admin/dashboard-app.md | 340/80 | 130/16 | 0/1 | 6/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：grafana-datasources.yaml、grafana.yaml、otel-collector.yaml、prometheus.yaml、tempo.yaml、zipkin.yaml、docker-compose.otel.yml、otel-connector-config.yaml |
...
| 数据库设计/数据库设计.md | 核心模块/src/backend/services/catalog-api.md | 309/77 | 129/15 | 0/1 | 6/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：diesel.toml、down.sql、up.sql、schema.rs、import.sql |
| 数据库设计/数据库迁移.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
| 数据库设计/数据模型.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
| 数据库设计/数据种子管理.md | 核心模块/src/backend/services/catalog-api.md | 256/77 | 100/15 | 0/1 | 6/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：down.sql、up.sql、schema.rs、mod.rs |
...
| 项目概述/快速开始指南.md | 项目概述.md | 262/85 | 102/15 | 0/1 | 5/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：contributing.md、readme.md、deployment.yaml、local-docker.postman_environment.js、docker-compose.yml、next.js、node.js |
| 项目概述/技术栈概览.md | 项目概述.md | 312/85 | 108/15 | 0/1 | 3/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、kustomization.yaml、deployment.yaml、cargo.toml、package.js、apinode.js、next.js、node.js |
| 项目概述/架构设计理念.md | 项目概述.md | 395/85 | 183/15 | 0/1 | 9/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、deployment.yaml、service.yaml、cargo.toml、package.js、node.js、next.js |
| 项目概述/项目介绍与目标.md | 项目概述.md | 315/85 | 185/15 | 19/1 | 7/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：cart-api.yml、contributing.md、readme.md、azure-pipelines.yml、deployment.yaml、docker-compose.yml、cargo.toml、package.js |
| 项目概述/项目概述.md | 项目概述.md | 334/85 | 179/15 | 21/1 | 7/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：contributing.md、readme.md、kafka-stateful-set.yaml、grafana.yaml、deployment.yaml、docker-compose.yml、cargo.toml、package.js |
...
- Evidence：0 / 1
- Mermaid：6 / 1
- 文件提及重合：layout.ts、fetch.ts、node.js、next.js
...
- Mermaid：5 / 2
- 文件提及重合：main.ts
- reference 关键文件未覆盖：readme.md、angular.js、package.js、app.module.ts、app.router.ts、shared.module.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、angular.js、package.js、app.module.ts、app.router.ts、shared.module.ts
...
- Evidence：0 / 1
- Mermaid：6 / 1
- 文件提及重合：app.module.ts、app.router.ts、main.ts、next.js
- reference 关键文件未覆盖：next.config.js、package.js、index.ts、layout.ts、providers.ts、tailwind.config.ts、angular.js、auth.guard.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：next.config.js、package.js、index.ts、layout.ts、providers.ts、tailwind.config.ts、angular.js、auth.guard.ts
...
- Evidence：0 / 1
- Mermaid：9 / 0
- 文件提及重合：service.yaml、http-route.yaml、kustomization.yaml
...
- Evidence：0 / 1
- Mermaid：10 / 1
- 文件提及重合：next.js、node.js
- reference 关键文件未覆盖：azure-pipelines.yml、grafana.yaml、prometheus.yaml、deployment.yaml、http-route.yaml、service.yaml、docker-compose.yml
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：azure-pipelines.yml、grafana.yaml、prometheus.yaml、deployment.yaml、http-route.yaml、service.yaml、docker-compose.yml
...
- Mermaid：8 / 1
- 文件提及重合：next.js、node.js
- reference 关键文件未覆盖：action.yml、cart-api.yml、checkout-api.yml、order-api.yml、payment-api.yml、web-app.yml、.gitpod.yml、contributing.md
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：action.yml、cart-api.yml、checkout-api.yml、order-api.yml、payment-api.yml、web-app.yml、.gitpod.yml、contributing.md
...
- Mermaid：8 / 1
- 文件提及重合：next.js、node.js
- reference 关键文件未覆盖：cart-api.postman_collection.js、catalog-api.postman_collection.js、checkout-api.postman_collection.js、local-docker.postman_environment.js、docker-compose.override.yml、docker-compose.yml、main.go、instrumentation.go
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：cart-api.postman_collection.js、catalog-api.postman_collection.js、checkout-api.postman_collection.js、local-docker.postman_environment.js、docker-compose.override.yml、docker-compose.yml、main.go、instrumentation.go
...
- Evidence：0 / 1
- Mermaid：7 / 1
- 文件提及重合：node.js、next.js
- reference 关键文件未覆盖：contributing.md、readme.md、azure-pipelines.yml、kustomization.yaml、docker-compose.yml、cargo.toml、package.js、apinode.js
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：contributing.md、readme.md、azure-pipelines.yml、kustomization.yaml、docker-compose.yml、cargo.toml、package.js、apinode.js
...
- Mermaid：8 / 1
- 文件提及重合：next.js、node.js
- reference 关键文件未覆盖：readme.md、deployment.yaml、cart_handler.go、cargo.toml、main.rs、package.js、index.ts、main.go
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、deployment.yaml、cart_handler.go、cargo.toml、main.rs、package.js、index.ts、main.go
...
- Mermaid：11 / 1
- 文件提及重合：next.js、node.js
- reference 关键文件未覆盖：cargo.toml、index.js、package.js
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：cargo.toml、index.js、package.js
...
- Evidence：21 / 1
- Mermaid：9 / 1
- 文件提及重合：.eslintrc.js、node.js、next.js
- reference 关键文件未覆盖：.rustfmt.toml、cargo.toml、package.js、tsconfig.js、tslint.js、prettier.config.js、tailwind.config.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：.rustfmt.toml、cargo.toml、package.js、tsconfig.js、tslint.js、prettier.config.js、tailwind.config.ts
...
- Evidence：16 / 1
- Mermaid：7 / 1
- 文件提及重合：.eslintrc.js、next.js、node.js
- reference 关键文件未覆盖：.rustfmt.toml、cargo.toml、package.js、tsconfig.js、prettier.config.js、package-lock.js
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：.rustfmt.toml、cargo.toml、package.js、tsconfig.js、prettier.config.js、package-lock.js
...
- Mermaid：7 / 1
- 文件提及重合：next.js、node.js
- reference 关键文件未覆盖：.gitpod.yml、contributing.md、readme.md
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：.gitpod.yml、contributing.md、readme.md
...
- Evidence：0 / 1
- Mermaid：3 / 1
- 文件提及重合：layout.ts、next.js、node.js
- reference 关键文件未覆盖：contributing.md、readme.md、docker-compose.override.yml、docker-compose.yml、cargo.toml、main.rs、package.js、index.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：contributing.md、readme.md、docker-compose.override.yml、docker-compose.yml、cargo.toml、main.rs、package.js、index.ts
...
- Mermaid：9 / 1
- 文件提及重合：next.js、node.js
- reference 关键文件未覆盖：.gitpod.yml、contributing.md、readme.md、azure-pipelines.yml、docker-compose.yml、cargo.toml、package.js
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：.gitpod.yml、contributing.md、readme.md、azure-pipelines.yml、docker-compose.yml、cargo.toml、package.js
...
- Mermaid：8 / 1
- 文件提及重合：next.js、node.js
- reference 关键文件未覆盖：readme.md、docker-compose.override.yml、docker-compose.yml、cargo.toml、main.rs、package.js、index.ts、main.go
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、docker-compose.override.yml、docker-compose.yml、cargo.toml、main.rs、package.js、index.ts、main.go
...
- Mermaid：9 / 1
- 文件提及重合：next.js、node.js
- reference 关键文件未覆盖：grafana.yaml、otel-collector.yaml、prometheus.yaml、docker-compose.otel.yml、performance-test-dasboard.js、datasource.yaml、db.go、cargo.toml
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：grafana.yaml、otel-collector.yaml、prometheus.yaml、docker-compose.otel.yml、performance-test-dasboard.js、datasource.yaml、db.go、cargo.toml
...
- Mermaid：4 / 1
- 文件提及重合：next.js、node.js
- reference 关键文件未覆盖：readme.md、basket-api.postman_collection.js、cart-api.postman_collection.js、catalog-api.postman_collection.js、checkout-api.postman_collection.js、local-docker.postman_environment.js、docker-compose.kafka.yml、docker-compose.otel.yml
...
- Mermaid：3 / 1
- 文件提及重合：next.js、node.js
- reference 关键文件未覆盖：.gitpod.yml、readme.md、kustomization.yaml、deployment.yaml、local-docker.postman_environment.js、docker-compose.override.yml、docker-compose.yml、main.rs
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：.gitpod.yml、readme.md、kustomization.yaml、deployment.yaml、local-docker.postman_environment.js、docker-compose.override.yml、docker-compose.yml、main.rs
...
- Mermaid：6 / 1
- 文件提及重合：next.js、node.js
- reference 关键文件未覆盖：grafana-datasources.yaml、grafana.yaml、otel-collector.yaml、prometheus.yaml、tempo.yaml、zipkin.yaml、docker-compose.otel.yml、otel-connector-config.yaml
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：grafana-datasources.yaml、grafana.yaml、otel-collector.yaml、prometheus.yaml、tempo.yaml、zipkin.yaml、docker-compose.otel.yml、otel-connector-config.yaml
