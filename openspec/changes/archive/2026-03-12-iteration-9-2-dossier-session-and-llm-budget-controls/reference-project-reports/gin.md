...
LLM usage：requests=32, total_tokens=119695, page_research=18, page_enrichment=0

## 覆盖统计

- 专题页覆盖：generated 10 / reference 12
- evidence 落页：generated 15 / reference 88
- 图表达覆盖：generated 7 / reference 88
- page research 请求：18
- page enrichment 请求：0
- 已规划专题类型：流程主题(8)、专题页(1)、路由主题(1)
- 高频缺失专题：核心机制主题(1)
...
- 专题/module-capability/module-8ad56fd848ad-library-render能力：扩展机制.md 被 4 个 reference 页面共享映射
- 专题/root-mechanism/root-core-根级核心机制.md 被 4 个 reference 页面共享映射
- 专题/process/process-runtls-flow-流程主题：RunTLS-flow.md 被 4 个 reference 页面共享映射
...
- 专题/process/process-run-flow-流程主题：Run-flow.md (流程主题：Run flow, 38 行)
- 专题/process/process-runfd-flow-流程主题：RunFd-flow.md (流程主题：RunFd flow, 36 行)
- 专题/process/process-runquic-flow-流程主题：RunQUIC-flow.md (流程主题：RunQUIC flow, 34 行)
- 专题/process/process-rununix-flow-流程主题：RunUnix-flow.md (流程主题：RunUnix flow, 34 行)
- 专题/process/process-testcontextresetinhandler-flow-流程主题：TestContextResetInHandler-flow.md (流程主题：TestContextResetInHandler flow, 22 行)
...
| 响应渲染/XML_YAML_TOML 渲染.md | 核心模块/render.md | 326/54 | 114/7 | 0/1 | 7/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：toml_test.go、xml_test.go、yaml.go、yaml_test.go、context_test.go、_test.go |
| 响应渲染/专用格式渲染.md | 专题/module-capability/module-8ad56fd848ad-library-render能力：扩展机制.md | 350/24 | 119/5 | 0/1 | 7/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：binding_msgpack_test.go、binding_test.go、msgpack.go、protobuf.go、reader.go、render.go、render_msgpack_test.go、render_test.go |
| 响应渲染/响应渲染.md | 核心模块/render.md | 470/54 | 242/7 | 0/1 | 10/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：context.go、msgpack.go、protobuf.go、reader.go、redirect.go、render.go、yaml.go、google.go |
...
| 响应渲染/渲染接口设计.md | 核心模块/render.md | 377/54 | 148/7 | 0/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：context.go、protobuf.go、reader.go、redirect.go、render.go、render_test.go、yaml.go、google.go |
...
| 性能优化/缓存机制.md | 专题/root-mechanism/root-core-根级核心机制.md | 348/25 | 131/5 | 0/1 | 8/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：benchmarks_test.go、context.go、fs.go、mode.go、render.go、response_writer.go |
...
| 数据绑定与验证/绑定机制原理/其他格式绑定.md | 专题/module-capability/module-8ad56fd848ad-library-render能力：扩展机制.md | 442/24 | 176/5 | 0/1 | 10/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：binding.go、default_validator.go、msgpack.go、plain.go、protobuf.go、toml.go、yaml.go、text.go |
| 数据绑定与验证/绑定机制原理/头部和URI绑定.md | 专题/root-mechanism/root-core-根级核心机制.md | 322/25 | 130/5 | 0/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：binding.go、default_validator.go、form_mapping.go、header.go、query.go、uri.go、context.go、doc.md |
| 数据绑定与验证/绑定机制原理/查询参数绑定.md | 专题/process/process-runtls-flow-流程主题：RunTLS-flow.md | 276/34 | 120/14 | 17/1 | 7/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：binding.go、binding_test.go、form.go、form_mapping.go、query.go、context.go、doc.md |
| 数据绑定与验证/绑定机制原理/绑定接口设计.md | 专题/module-capability/module-8ad56fd848ad-library-render能力：扩展机制.md | 359/24 | 174/5 | 0/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：binding.go、binding_test.go、default_validator.go、form.go、form_mapping.go、header.go、json.go、query.go |
| 数据绑定与验证/绑定机制原理/绑定机制原理.md | 专题/module-capability/module-8ad56fd848ad-library-render能力：扩展机制.md | 373/24 | 178/5 | 0/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：binding.go、default_validator.go、form.go、form_mapping.go、header.go、json.go、msgpack.go、multipart_form_mapping.go |
| 数据绑定与验证/绑定机制原理/表单绑定实现.md | 专题/process/process-runtls-flow-流程主题：RunTLS-flow.md | 576/34 | 420/14 | 27/1 | 16/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：binding.go、binding_test.go、default_validator.go、form.go、form_mapping.go、form_mapping_test.go、multipart_form_mapping.go、multipart_form_mapping_test.go |
| 数据绑定与验证/绑定机制原理/验证集成机制.md | 专题/process/process-runtls-flow-流程主题：RunTLS-flow.md | 326/34 | 126/14 | 0/1 | 7/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：binding.go、binding_test.go、default_validator.go、default_validator_test.go、form.go、form_mapping.go、json.go、validate_test.go |
| 数据绑定与验证/自定义绑定器.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
...
| 核心架构/Context 上下文管理.md | 系统架构.md | 348/35 | 108/4 | 0/1 | 4/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：context.go、context_test.go、gin.go、response_writer.go、test_helpers.go |
...
| 核心架构/RouterGroup 路由分组系统.md | 系统架构.md | 318/35 | 115/4 | 0/1 | 8/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：context.go、doc.md、gin.go、path.go、tree.go、utils.go |
| 核心架构/核心架构.md | 系统架构.md | 356/35 | 153/4 | 0/1 | 7/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：context.go、debug.go、errors.go、gin.go、mode.go、response_writer.go、tree.go |
...
| 核心架构/路由树实现原理.md | 系统架构.md | 342/35 | 216/4 | 17/1 | 7/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：context.go、gin.go、path.go、tree.go、tree_test.go |
| 测试策略/单元测试.md | 系统架构.md | 530/35 | 310/4 | 28/1 | 13/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：auth_test.go、context_file_test.go、context_test.go、errors_test.go、gin_integration_test.go、middleware_test.go、response_writer_test.go、test_helpers.go |
...
| 请求处理/流程控制机制.md | 专题/root-mechanism/root-core-根级核心机制.md | 291/25 | 116/5 | 0/1 | 5/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：context.go、context_test.go、middleware_test.go |
...
| 请求处理/错误处理机制.md | 专题/process/process-runtls-flow-流程主题：RunTLS-flow.md | 309/34 | 125/14 | 0/1 | 6/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：context.go、context_test.go、debug.go、errors.go、errors_test.go、recovery.go、recovery_test.go |
...
| 路由系统/路由注册机制.md | 专题/root-mechanism/root-core-根级核心机制.md | 263/25 | 103/5 | 0/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：path.go、tree_test.go |
...
- Evidence：0 / 1
- Mermaid：7 / 0
- 文件提及重合：toml.go、xml.go
- reference 关键文件未覆盖：toml_test.go、xml_test.go、yaml.go、yaml_test.go、context_test.go、_test.go
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：toml_test.go、xml_test.go、yaml.go、yaml_test.go、context_test.go、_test.go

### 响应渲染/专用格式渲染.md

- reference 标题：专用格式渲染
- 生成页：专题/module-capability/module-8ad56fd848ad-library-render能力：扩展机制.md（render能力：扩展机制）
- 匹配分数：90
- 页面类型：other / topic
- 行数：350 / 24
- 段落行数：119 / 5
...
- Evidence：0 / 1
- Mermaid：10 / 0
- 文件提及重合：bson.go、data.go、html.go、json.go、pdf.go、text.go、toml.go、xml.go
- reference 关键文件未覆盖：context.go、msgpack.go、protobuf.go、reader.go、redirect.go、render.go、yaml.go、google.go
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：context.go、msgpack.go、protobuf.go、reader.go、redirect.go、render.go、yaml.go、google.go
...
- Mermaid：6 / 0
- 文件提及重合：bson.go、data.go、html.go、json.go、pdf.go、text.go、toml.go、xml.go
- reference 关键文件未覆盖：context.go、protobuf.go、reader.go、redirect.go、render.go、render_test.go、yaml.go、google.go
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：context.go、protobuf.go、reader.go、redirect.go、render.go、render_test.go、yaml.go、google.go
...
- Evidence：0 / 1
- Mermaid：10 / 0
- 文件提及重合：bson.go、xml.go
- reference 关键文件未覆盖：binding.go、default_validator.go、msgpack.go、plain.go、protobuf.go、toml.go、yaml.go、text.go
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：binding.go、default_validator.go、msgpack.go、plain.go、protobuf.go、toml.go、yaml.go、text.go
...
- reference 标题：查询参数绑定
- 生成页：专题/process/process-runtls-flow-流程主题：RunTLS-flow.md（流程主题：RunTLS flow）
- 匹配分数：90
- 页面类型：topic / topic
- 行数：276 / 34
- 段落行数：120 / 14
...
- Mermaid：7 / 1
- 文件提及重合：无
- reference 关键文件未覆盖：binding.go、binding_test.go、form.go、form_mapping.go、query.go、context.go、doc.md
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：binding.go、binding_test.go、form.go、form_mapping.go、query.go、context.go、doc.md
...
- Mermaid：6 / 0
- 文件提及重合：xml.go
- reference 关键文件未覆盖：binding.go、binding_test.go、default_validator.go、form.go、form_mapping.go、header.go、json.go、query.go
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：binding.go、binding_test.go、default_validator.go、form.go、form_mapping.go、header.go、json.go、query.go
...
- Mermaid：6 / 0
- 文件提及重合：bson.go、xml.go
- reference 关键文件未覆盖：binding.go、default_validator.go、form.go、form_mapping.go、header.go、json.go、msgpack.go、multipart_form_mapping.go
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：binding.go、default_validator.go、form.go、form_mapping.go、header.go、json.go、msgpack.go、multipart_form_mapping.go
...
- Mermaid：16 / 1
- 文件提及重合：无
- reference 关键文件未覆盖：binding.go、binding_test.go、default_validator.go、form.go、form_mapping.go、form_mapping_test.go、multipart_form_mapping.go、multipart_form_mapping_test.go
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：binding.go、binding_test.go、default_validator.go、form.go、form_mapping.go、form_mapping_test.go、multipart_form_mapping.go、multipart_form_mapping_test.go
...
- Mermaid：7 / 1
- 文件提及重合：无
- reference 关键文件未覆盖：binding.go、binding_test.go、default_validator.go、default_validator_test.go、form.go、form_mapping.go、json.go、validate_test.go
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：binding.go、binding_test.go、default_validator.go、default_validator_test.go、form.go、form_mapping.go、json.go、validate_test.go
