...
LLM usage：requests=29, total_tokens=128670, page_research=11, page_enrichment=2

## 覆盖统计

- 专题页覆盖：generated 24 / reference 7（repo-archetype=3）
- evidence 落页：generated 48 / reference 65
- citation 密度：generated 0.94 / reference 79.69
- 图表达覆盖：generated 43 / reference 65
- page research 请求：11
- page enrichment 请求：2
- 已规划专题类型：专题页(16)、流程主题(8)
- 高频缺失专题：无
...
- 核心模块/dagger-android.md 被 2 个 reference 页面共享映射
- 核心模块/dagger-producers.md 被 2 个 reference 页面共享映射
- 核心模块/hilt-core.md 被 3 个 reference 页面共享映射
- 专题/process/process-getsavedstatehandle-flow-流程主题：getSavedStateHandle-flow.md 被 2 个 reference 页面共享映射
- 专题/module-capability/module-4157350ffac0-plugin-java能力：扩展机制.md 被 2 个 reference 页面共享映射
...
- 专题/process/process-testdelaycomponentreadyafterstart_fails-flow-流程主题：testDelayComponentReadyAfterStart_fails-flow.md (流程主题：testDelayComponentReadyAfterStart_fails flow, 28 行)
- 专题/repo-archetype/config-runtime-配置与运行时.md (配置与运行时, 42 行)
- 专题/repo-archetype/core-api-models-核心-API-与数据模型.md (核心 API 与数据模型, 28 行)
- 专题/repo-archetype/request-lifecycle-请求处理链.md (请求处理链, 42 行)
- 核心模块/buildSrc.md (模块：buildSrc, 109 行)
...
- 核心模块/dagger-kythe.md (模块：dagger-kythe, 58 行)
...
| API参考文档/Android API.md | 核心模块/dagger-android.md | 398/77 | 168/22 | 21/1 | 8/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、androidinjectordescriptor.java、contributesandroidinjectorprocessingstep.java、androidsupportinjection.java、androidsupportinjectionmodule.java、androidinjectionmodule.java、contributesandroidinjector.java、dispatchingandroidinjector.java |
...
| Android集成开发/Android生命周期管理.md | 核心模块/dagger-android.md | 383/77 | 153/22 | 21/1 | 8/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：contributesandroidinjectorprocessingstep.java、daggerappcompatactivity.java、androidinjectionmodule.java、contributesandroidinjector.java、dispatchingandroidinjector.java、hasandroidinjector.java、androidinjectiontest.java、dispatchingandroidinjectortest.java |
...
| 编译时处理机制/编译时处理机制.md | 专题/process/process-getsavedstatehandle-flow-流程主题：getSavedStateHandle-flow.md | 327/31 | 135/14 | 0/1 | 5/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：componentprocessor.java、delegatecomponentprocessor.java、kspcomponentprocessor.java、processingenvironmentmodule.java、validationreport.java、bindinggraphfactory.java、bindinggraphvalidationmodule.java、compositebindinggraphplugin.java |
| 编译时处理机制/验证与错误处理.md | 专题/process/process-assertnostartednodes-flow-流程主题：assertNoStartedNodes-flow.md | 399/45 | 180/24 | 0/2 | 9/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：validationreport.java、errormessages.java、bindinggraphplugin.java、diagnosticreporter.java、bindinggraphvalidator.java、componentvalidator.java、diagnosticreporterfactory.java、modulevalidator.java |
| 贡献指南.md | 专题/module-capability/module-76f4cd583a47-plugin-buildSrc能力：扩展机制.md | 251/66 | 71/45 | 0/1 | 3/1 | 内容明显短于 reference；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：contributing.md、readme.md、settings.gradle.kt、libs.versions.toml |
| 项目概述.md | 项目概述.md | 244/198 | 114/127 | 0/1 | 7/1 | 章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：contributing.md、readme.md、componentprocessor.java、delegatecomponentprocessor.java、component.java、lazy.java、module.java、subcomponent.java |
| 高级特性与扩展/SPI扩展机制.md | 专题/process/process-assertnotstarted-flow-流程主题：assertNotStarted-flow.md | 393/45 | 185/28 | 0/1 | 8/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：serviceloaders.java、compositebindinggraphplugin.java、diagnosticreporterfactory.java、externalbindinggraphplugins.java、validationbindinggraphplugin.java、validationbindinggraphplugins.java、bindinggraphplugin.java、diagnosticreporter.java |
...
- Evidence：21 / 1
- Mermaid：8 / 1
- 文件提及重合：androidinjection.java、androidinjector.java、daggeractivity.java、daggerapplication.java、daggerfragment.java、daggerservice.java
- reference 关键文件未覆盖：readme.md、androidinjectordescriptor.java、contributesandroidinjectorprocessingstep.java、androidsupportinjection.java、androidsupportinjectionmodule.java、androidinjectionmodule.java、contributesandroidinjector.java、dispatchingandroidinjector.java
...
- Evidence：21 / 1
- Mermaid：8 / 1
- 文件提及重合：androidinjection.java、androidinjector.java、daggeractivity.java、daggerapplication.java、daggerfragment.java
- reference 关键文件未覆盖：contributesandroidinjectorprocessingstep.java、daggerappcompatactivity.java、androidinjectionmodule.java、contributesandroidinjector.java、dispatchingandroidinjector.java、hasandroidinjector.java、androidinjectiontest.java、dispatchingandroidinjectortest.java
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：contributesandroidinjectorprocessingstep.java、daggerappcompatactivity.java、androidinjectionmodule.java、contributesandroidinjector.java、dispatchingandroidinjector.java、hasandroidinjector.java、androidinjectiontest.java、dispatchingandroidinjectortest.java
...
- reference 标题：代码生成策略
- 生成页：专题/process/process-getsavedstatehandle-flow-流程主题：getSavedStateHandle-flow.md（流程主题：getSavedStateHandle flow）
- 匹配分数：98
- 页面类型：topic / topic
- 行数：361 / 31
- 段落行数：159 / 14
...
- 生成页：专题/process/process-assertnostartednodes-flow-流程主题：assertNoStartedNodes-flow.md（流程主题：assertNoStartedNodes flow）
- 匹配分数：92
- 页面类型：topic / topic
- 行数：399 / 45
- 段落行数：180 / 24
...
- Evidence：0 / 1
- Mermaid：3 / 1
- 文件提及重合：build.gradle.kt
- reference 关键文件未覆盖：contributing.md、readme.md、settings.gradle.kt、libs.versions.toml
- 结论：内容明显短于 reference；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：contributing.md、readme.md、settings.gradle.kt、libs.versions.toml
...
- 结论：章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：contributing.md、readme.md、componentprocessor.java、delegatecomponentprocessor.java、component.java、lazy.java、module.java、subcomponent.java

### 高级特性与扩展/SPI扩展机制.md

- reference 标题：SPI扩展机制
- 生成页：专题/process/process-assertnotstarted-flow-流程主题：assertNotStarted-flow.md（流程主题：assertNotStarted flow）
- 匹配分数：96
- 页面类型：topic / topic
- 行数：393 / 45
- 段落行数：185 / 28
