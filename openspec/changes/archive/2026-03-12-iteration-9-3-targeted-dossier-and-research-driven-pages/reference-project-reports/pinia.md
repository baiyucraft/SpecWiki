...
LLM usage：requests=29, total_tokens=204367, page_research=11, page_enrichment=2

## 覆盖统计

- 专题页覆盖：generated 17 / reference 6（repo-archetype=2）
- evidence 落页：generated 29 / reference 61
- citation 密度：generated 1.06 / reference 73.67
- 图表达覆盖：generated 26 / reference 61
- page research 请求：11
- page enrichment 请求：2
- 已规划专题类型：专题页(10)、流程主题(7)
- 高频缺失专题：无
...
- 核心模块/packages.md 被 32 个 reference 页面共享映射
- 核心模块/packages/online-playground/src.md 被 13 个 reference 页面共享映射
...
- 专题/module-capability/module-08246e30f71f-component-docs能力：界面组成.md (docs能力：界面组成, 40 行)
...
- 核心模块/packages/docs.md (模块：docs, 55 行)
- 核心模块/packages/online-playground.md (模块：online-playground, 81 行)
- 核心模块/packages/online-playground/src/download.md (模块：download, 86 行)
- 核心模块/packages/online-playground/src/download/template.md (模块：template, 49 行)
- 核心模块/packages/pinia.md (模块：pinia, 108 行)
- 核心模块/packages/playground.md (模块：playground, 76 行)
- 核心模块/packages/size-check.md (模块：size-check, 54 行)
- 核心模块/packages/testing.md (模块：testing, 64 行)
...
| 开发工具/Playground 演示平台.md | 核心模块/packages/online-playground/src.md | 240/74 | 84/29 | 0/1 | 5/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：vite.config.ts |
...
| 开发工具/开发工具.md | 核心模块/packages/online-playground/src.md | 313/74 | 114/29 | 0/1 | 8/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：netlify.toml、vite.config.ts、tsdown.config.ts、pnpm-workspace.yaml、vite.conf、index.ts |
| 开发工具/文档生成系统.md | 核心模块/packages/online-playground/src.md | 301/74 | 104/29 | 0/1 | 7/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：netlify.toml、en.ts、shared.ts、zh.ts、typedoc.tsconfig.js、vite-typedoc-plugin.ts、pnpm-workspace.yaml |
...
| 快速开始.md | 核心模块/packages/online-playground/src.md | 205/74 | 59/29 | 0/1 | 3/2 | 内容明显短于 reference；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：actions.md、getters.md、index.md、state.md、getting-started.md、counter.ts |
...
| 最佳实践/团队协作规范.md | 核心模块/packages/online-playground/src.md | 301/74 | 99/29 | 0/1 | 5/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：code_of_conduct.md、contributing.md、issue_template.md、pull_request_template.md、commit-convention.md、.spec.ts、.test.ts、pnpm-workspace.yaml |
| 最佳实践/常见陷阱与反模式.md | 核心模块/packages/online-playground/src.md | 270/74 | 103/29 | 0/1 | 6/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：composing-stores.md、testing.md、actions.md、getters.md、index.md、state.md、getting-started.md、counter.ts |
...
| 最佳实践/最佳实践.md | 核心模块/packages/online-playground/src.md | 268/74 | 85/29 | 0/1 | 5/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：code_of_conduct.md、contributing.md、composing-stores.md、testing.md、actions.md、getters.md、index.md、state.md |
...
| 最佳实践/项目结构组织.md | 核心模块/packages/online-playground/src.md | 241/74 | 114/29 | 0/1 | 6/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：code_of_conduct.md、contributing.md、commit-convention.md、pnpm-workspace.yaml、tsconfig.js、counterstore.ts、usexxxstore.ts、userstore.ts |
...
| 核心概念/状态管理机制/动作跟踪与拦截.md | 专题/module-capability/module-2799d89a93ec-repository-playground能力：数据访问.md | 220/51 | 85/26 | 0/2 | 4/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：actions.md、onaction.spec.ts、rootstore.ts、store.ts、subscriptions.ts、types.ts |
| 核心概念/状态管理机制/响应式状态系统.md | 核心模块/packages.md | 384/81 | 181/24 | 22/1 | 10/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；reference 专题被折叠进非专题页；缺少关键文件提及：index.md、env.ts、globalextensions.ts、hmr.ts、maphelpers.ts、storetorefs.ts、subscriptions.ts、types.ts |
...
| 核心概念/状态管理机制/状态管理机制.md | 核心模块/packages.md | 378/81 | 164/24 | 0/1 | 9/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；reference 专题被折叠进非专题页；缺少关键文件提及：env.ts、subscriptions.ts、types.ts、wholestore.ts |
| 核心概念/状态管理机制/状态补丁与重置.md | 专题/module-capability/module-93bb514e371a-entry-pinia能力：入口编排.md | 267/54 | 106/34 | 18/1 | 6/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：state.spec.ts、store.patch.spec.ts、store.ts、types.ts、testing.ts |
| 核心概念/状态管理机制/状态订阅系统.md | 专题/module-capability/module-2799d89a93ec-repository-playground能力：数据访问.md | 327/51 | 124/26 | 0/2 | 6/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：pinia.mutationtype.md、state.md、subscriptions.spec.ts、formatting.ts、plugin.ts、store.ts、subscriptions.ts、types.ts |
...
| 测试策略/集成测试.md | 核心模块/packages/online-playground/src.md | 293/74 | 99/29 | 0/1 | 6/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：.spec.ts、combinedstores.spec.ts、onaction.spec.ts、state.spec.ts、storeplugins.spec.ts、subscriptions.spec.ts、initialstate.spec.ts、mocked-store.spec.ts |
| 示例教程/在线演示.md | 核心模块/packages/online-playground/src.md | 242/74 | 87/29 | 0/1 | 5/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：netlify.toml、defaults.ts、formatting.ts、plugin.ts |
...
| 示例教程/实战场景.md | 核心模块/packages/online-playground/src.md | 259/74 | 110/29 | 0/1 | 7/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：actions.md、getters.md、index.md、state.md、getting-started.md |
...
| 示例教程/进阶示例.md | 核心模块/packages/nuxt/playground.md | 268/64 | 138/21 | 19/3 | 9/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、migration-vuex.md、plugins.md、hmr.spec.ts、cart.ts、user.ts |
| 贡献指南.md | 核心模块/packages/online-playground/src.md | 223/74 | 81/29 | 0/1 | 4/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：code_of_conduct.md、contributing.md、issue_template.md、pull_request_template.md、commit-convention.md、.prettierrc.js、codecov.yml、pnpm-workspace.yaml |
...
| 高级功能/Devtools 集成.md | 核心模块/packages.md | 232/81 | 75/24 | 0/1 | 4/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、package.js、actions.ts、formatting.ts、utils.ts、types.ts、tsdown.config.ts、vite-env.d.ts |
...
| 高级功能/状态持久化.md | 核心模块/packages/online-playground/src.md | 267/74 | 94/29 | 0/1 | 5/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：plugins.md、index.md、with-skip-hydrate.ts、actions.ts、env.ts |
| 高级功能/高级功能.md | 核心模块/packages.md | 331/81 | 136/24 | 17/1 | 7/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、package.js、plugins.md、index.md、ssr.spec.ts、storeplugins.spec.ts、actions.ts、formatting.ts |
...
- 结论：内容明显短于 reference；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：actions.md、getters.md、index.md、state.md、getting-started.md、counter.ts
...
- Evidence：15 / 1
- Mermaid：3 / 1
- 文件提及重合：counter.ts、with-skip-hydrate.ts、plugin.ts
...
- Evidence：22 / 1
- Mermaid：10 / 1
- 文件提及重合：payload-plugin.ts、createpinia.ts、index.ts、rootstore.ts、store.ts
- reference 关键文件未覆盖：index.md、env.ts、globalextensions.ts、hmr.ts、maphelpers.ts、storetorefs.ts、subscriptions.ts、types.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；reference 专题被折叠进非专题页；缺少关键文件提及：index.md、env.ts、globalextensions.ts、hmr.ts、maphelpers.ts、storetorefs.ts、subscriptions.ts、types.ts
...
- Mermaid：5 / 2
- 文件提及重合：readme.md、package.js、main.ts
- reference 关键文件未覆盖：plugins.md、index.md、with-skip-hydrate.ts、actions.ts、env.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：plugins.md、index.md、with-skip-hydrate.ts、actions.ts、env.ts
...
- Evidence：17 / 1
- Mermaid：7 / 1
- 文件提及重合：with-skip-hydrate.ts、createpinia.ts、plugin.ts、index.ts、rootstore.ts、store.ts
- reference 关键文件未覆盖：readme.md、package.js、plugins.md、index.md、ssr.spec.ts、storeplugins.spec.ts、actions.ts、formatting.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、package.js、plugins.md、index.md、ssr.spec.ts、storeplugins.spec.ts、actions.ts、formatting.ts
