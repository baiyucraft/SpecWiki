...
LLM usage：requests=27, total_tokens=156430, page_research=13, page_enrichment=2

## 覆盖统计

- 专题页覆盖：generated 14 / reference 5（repo-archetype=3）
- evidence 落页：generated 15 / reference 86
- citation 密度：generated 0.9 / reference 78.22
- 图表达覆盖：generated 11 / reference 86
- page research 请求：13
- page enrichment 请求：2
- 已规划专题类型：流程主题(8)、专题页(6)
- 高频缺失专题：无
...
- 核心模块/spider.md 被 29 个 reference 页面共享映射
- 专题/process/process-get_last_run_time-flow-流程主题：get_last_run_time-flow.md 被 13 个 reference 页面共享映射
- 系统架构.md 被 8 个 reference 页面共享映射
- 核心模块/web.md 被 8 个 reference 页面共享映射
- 专题/process/process-api_news_find-flow-流程主题：api_news_find-flow.md 被 3 个 reference 页面共享映射
- 专题/process/process-api_get_log-flow-流程主题：api_get_log-flow.md 被 2 个 reference 页面共享映射
- 工作流与部署.md 被 6 个 reference 页面共享映射
- 专题/process/process-api_links-flow-流程主题：api_links-flow.md 被 2 个 reference 页面共享映射
- 项目概述.md 被 2 个 reference 页面共享映射

## 额外生成页面

- 专题/module-capability/module-240f4d7393a9-plugin-nginx能力：扩展机制.md (nginx能力：扩展机制, 24 行)
- 专题/module-capability/module-4c517846f747-repository-spider能力：数据访问.md (spider能力：数据访问, 33 行)
- 专题/module-capability/module-5380ddae5fb7-component-web能力：界面组成.md (web能力：界面组成, 35 行)
- 专题/process/process-update_data-flow-流程主题：update_data-flow.md (流程主题：update_data flow, 37 行)
...
- 核心模块/nginx/conf.md (模块：conf, 29 行)
...
| API接口文档/新闻API.md | 核心模块/spider.md | 377/78 | 101/15 | 0/1 | 5/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、utils.py、index.ts、news.ts |
...
| API接口文档/转换API.md | 核心模块/spider.md | 363/78 | 146/15 | 19/1 | 6/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：compare_video.py、compressmkv.py、mergetomkv.py、output.py、utils.py、spec.md、convert.ts |
| 前端开发指南/API集成.md | 专题/process/process-get_last_run_time-flow-流程主题：get_last_run_time-flow.md | 380/23 | 163/6 | 0/1 | 8/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、convert.ts、crawler.ts、links.ts、news.ts、globalticker.ts、vite.config.ts |
| 前端开发指南/UI设计系统.md | 专题/process/process-get_last_run_time-flow-流程主题：get_last_run_time-flow.md | 308/23 | 108/6 | 0/1 | 7/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、uno.config.ts、vite.config.ts |
...
| 前端开发指南/前端开发指南.md | 专题/process/process-get_last_run_time-flow-流程主题：get_last_run_time-flow.md | 285/23 | 104/6 | 0/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、links.ts、news.ts、vite.config.ts |
...
| 前端开发指南/组件开发/UI组件集成.md | 专题/process/process-get_last_run_time-flow-流程主题：get_last_run_time-flow.md | 395/23 | 229/6 | 18/1 | 9/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、news.ts、uno.config.ts、vite.config.ts |
| 前端开发指南/组件开发/基础组件开发.md | 专题/process/process-api_news_find-flow-流程主题：api_news_find-flow.md | 475/49 | 336/24 | 20/2 | 12/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、news.ts、vite.config.ts、crawler.ts、links.ts |
| 前端开发指南/组件开发/组件开发.md | 核心模块/web.md | 374/81 | 127/17 | 0/1 | 5/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、globalticker.ts、vite.config.ts |
| 前端开发指南/组件开发/高级组件模式.md | 专题/process/process-get_last_run_time-flow-流程主题：get_last_run_time-flow.md | 328/23 | 130/6 | 0/1 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、crawler.ts、news.ts、globalticker.ts、vite.config.ts |
| 前端开发指南/路由系统.md | 专题/process/process-get_last_run_time-flow-流程主题：get_last_run_time-flow.md | 254/23 | 78/6 | 0/1 | 5/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、convert.ts、news.ts、vite.config.ts |
...
| 后端开发指南/爬虫引擎系统/同步爬取机制.md | 专题/process/process-run_feedback_cycle-flow-流程主题：run_feedback_cycle-flow.md | 345/39 | 158/20 | 0/1 | 7/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、async_fetch.py、crawler_config.py、gc_spider.py、gc_sql.py、utils.py |
| 后端开发指南/爬虫引擎系统/异步爬取机制.md | 专题/process/process-api_get_log-flow-流程主题：api_get_log-flow.md | 432/23 | 248/6 | 18/1 | 9/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、async_fetch.py、crawler_config.py、gc_spider.py、gc_sql.py、utils.py、design.md、spec.md |
...
| 后端开发指南/爬虫引擎系统/调度与定时机制.md | 专题/process/process-api_get_log-flow-流程主题：api_get_log-flow.md | 437/23 | 310/6 | 21/1 | 12/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、async_fetch.py、crawler_config.py、gc_spider.py、gc_sql.py、spec.md、design.md、add_sys_data_update_interval.sql |
| 后端开发指南/视频转换系统/MKV文件合并.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
| 后端开发指南/视频转换系统/任务管理系统.md | 核心模块/spider.md | 282/78 | 112/15 | 0/1 | 7/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、compare_video.py、compressmkv.py、mergetomkv.py、output.py、utils.py、design.md、spec.md |
| 后端开发指南/视频转换系统/子进程集成机制.md | 专题/process/process-run_ffmpeg_with_progress-flow-流程主题：run_ffmpeg_with_progress-flow.md | 284/42 | 127/17 | 0/1 | 6/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、__init__.py、compare_video.py、compressmkv.py、func.py、mergetomkv.py、output.py、utils.py |
...
| 开发规范/代码规范.md | 专题/process/process-api_news_find-flow-流程主题：api_news_find-flow.md | 335/49 | 105/24 | 0/2 | 3/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、func.py、gc_spider.py、eslint.conf、package.js、links.ts、news.ts、tsconfig.js |
| 开发规范/开发工具配置.md | 缺失 | - | - | - | - | 缺少对应生成页面 |
| 开发规范/开发规范.md | 专题/process/process-get_last_run_time-flow-流程主题：get_last_run_time-flow.md | 390/23 | 129/6 | 0/1 | 5/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、spec.md、readme.md、eslint.conf、package.js、vite.config.ts、design.md、tasks.md |
| 开发规范/文档规范.md | 专题/process/process-api_news_find-flow-流程主题：api_news_find-flow.md | 324/49 | 142/24 | 0/2 | 6/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：code_of_conduct.md、contributing.md、readme.md、security.md、config.yaml、func.py、gc_spider.py、package.js |
...
| 扩展与定制/性能优化定制.md | 专题/process/process-api_links-flow-流程主题：api_links-flow.md | 318/41 | 119/12 | 0/4 | 6/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、compressmkv.py、func.py、async_fetch.py、crawler_config.py、gc_sql.py、utils.py、add_all_indexes.sql |
| 扩展与定制/扩展与定制.md | 核心模块/spider.md | 339/78 | 140/15 | 0/1 | 5/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、compare_video.py、compressmkv.py、mergetomkv.py、output.py、utils.py、links.js、async_fetch.py |
| 扩展与定制/插件开发机制.md | 核心模块/spider.md | 373/78 | 151/15 | 0/1 | 7/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；reference 专题被折叠进非专题页；缺少关键文件提及：config.yaml、compressmkv.py、mergetomkv.py、links.js、async_fetch.py、crawler_config.py、utils.py |
| 扩展与定制/界面定制方案.md | 专题/process/process-get_last_run_time-flow-流程主题：get_last_run_time-flow.md | 384/23 | 163/6 | 0/1 | 12/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、uno.config.ts、vite.config.ts |
...
| 核心功能模块/内容展示系统/UI组件库.md | 核心模块/web.md | 370/81 | 149/17 | 0/1 | 5/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：crawler.ts、globalticker.ts |
| 核心功能模块/内容展示系统/内容展示系统.md | 核心模块/web.md | 338/81 | 153/17 | 0/1 | 8/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、convert.ts、uno.config.ts、vite.config.ts |
...
| 核心功能模块/内容展示系统/视频转换界面.md | 核心模块/web.md | 346/81 | 185/17 | 14/1 | 6/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：func.py、output.py、utils.py、convert.ts、globalticker.ts |
...
| 核心功能模块/视频转换系统/视频处理工具集.md | 核心模块/spider.md | 363/78 | 159/15 | 0/1 | 9/1 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、compare_video.py、compressmkv.py、mergetomkv.py、output.py、utils.py、convert.ts |
...
| 系统架构/组件交互机制.md | 系统架构.md | 326/61 | 133/20 | 0/1 | 6/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、convert.ts、crawler.ts、news.ts、globalticker.ts |
...
| 部署与运维/服务部署/Docker容器化部署.md | 专题/process/process-get_last_run_time-flow-流程主题：get_last_run_time-flow.md | 270/23 | 57/6 | 0/1 | 3/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、package.js、vite.config.ts、node.js、docker-compose.yml、fastcgi.conf |
...
| 部署与运维/服务部署/Vue前端应用部署.md | 专题/process/process-get_last_run_time-flow-流程主题：get_last_run_time-flow.md | 292/23 | 84/6 | 0/1 | 3/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、package.js、tsconfig.app.js、tsconfig.node.js、uno.config.ts、vite.config.ts |
...
| 部署与运维/环境配置.md | 专题/process/process-get_last_run_time-flow-流程主题：get_last_run_time-flow.md | 329/23 | 129/6 | 0/1 | 7/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、config.yaml、crawler_config.py、gc_sql.py、package.js、crawler.ts、vite.config.ts、node.js |
| 部署与运维/监控与日志.md | 项目概述.md | 324/82 | 147/22 | 0/0 | 7/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、gc_spider.py、utils.py、design.md、spec.md、crawler.ts、news.ts |
| 部署与运维/部署与运维.md | 专题/process/process-get_last_run_time-flow-流程主题：get_last_run_time-flow.md | 306/23 | 76/6 | 0/1 | 4/0 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：readme.md、security.md、config.yaml、links.js、package.js、vite.config.ts |
| 项目概述.md | 项目概述.md | 351/82 | 192/22 | 18/0 | 8/2 | 内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、func.py、gc_spider.py、gc_sql.py、package.js、news.ts、vite.config.ts |
...
- Evidence：19 / 1
- Mermaid：6 / 1
- 文件提及重合：app.py、func.py、xunlei.py
- reference 关键文件未覆盖：compare_video.py、compressmkv.py、mergetomkv.py、output.py、utils.py、spec.md、convert.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：compare_video.py、compressmkv.py、mergetomkv.py、output.py、utils.py、spec.md、convert.ts

### 前端开发指南/API集成.md

- reference 标题：API集成
- 生成页：专题/process/process-get_last_run_time-flow-流程主题：get_last_run_time-flow.md（流程主题：get_last_run_time flow）
- 匹配分数：144
- 页面类型：other / topic
- 行数：380 / 23
- 段落行数：163 / 6
- Evidence：0 / 1
- Mermaid：8 / 0
- 文件提及重合：nginx.conf、index.ts、main.ts
- reference 关键文件未覆盖：package.js、convert.ts、crawler.ts、links.ts、news.ts、globalticker.ts、vite.config.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、convert.ts、crawler.ts、links.ts、news.ts、globalticker.ts、vite.config.ts
...
- reference 标题：基础组件开发
- 生成页：专题/process/process-api_news_find-flow-流程主题：api_news_find-flow.md（流程主题：api_news_find flow）
- 匹配分数：60
- 页面类型：other / topic
- 行数：475 / 49
- 段落行数：336 / 24
...
- Mermaid：12 / 2
- 文件提及重合：main.ts、index.ts
- reference 关键文件未覆盖：package.js、news.ts、vite.config.ts、crawler.ts、links.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、news.ts、vite.config.ts、crawler.ts、links.ts
...
- Evidence：0 / 1
- Mermaid：5 / 1
- 文件提及重合：index.ts、main.ts、news.ts
...
- Evidence：0 / 1
- Mermaid：7 / 1
- 文件提及重合：app.py、func.py、gc_spider.py、gc_sql.py、xunlei.py
...
- Mermaid：9 / 0
- 文件提及重合：app.py
- reference 关键文件未覆盖：config.yaml、async_fetch.py、crawler_config.py、gc_spider.py、gc_sql.py、utils.py、design.md、spec.md
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、async_fetch.py、crawler_config.py、gc_spider.py、gc_sql.py、utils.py、design.md、spec.md
...
- Mermaid：7 / 1
- 文件提及重合：app.py、func.py、xunlei.py
- reference 关键文件未覆盖：config.yaml、compare_video.py、compressmkv.py、mergetomkv.py、output.py、utils.py、design.md、spec.md
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、compare_video.py、compressmkv.py、mergetomkv.py、output.py、utils.py、design.md、spec.md
...
- Evidence：0 / 2
- Mermaid：3 / 2
- 文件提及重合：app.py、main.ts、index.ts
- reference 关键文件未覆盖：config.yaml、func.py、gc_spider.py、eslint.conf、package.js、links.ts、news.ts、tsconfig.js
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、func.py、gc_spider.py、eslint.conf、package.js、links.ts、news.ts、tsconfig.js
...
### 扩展与定制/OpenSpec规范管理.md

- reference 标题：OpenSpec规范管理
- 生成页：无
- 问题：缺少对应生成页面
...
- Mermaid：5 / 1
- 文件提及重合：app.py、func.py、gc_spider.py、gc_sql.py
- reference 关键文件未覆盖：config.yaml、compare_video.py、compressmkv.py、mergetomkv.py、output.py、utils.py、links.js、async_fetch.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：config.yaml、compare_video.py、compressmkv.py、mergetomkv.py、output.py、utils.py、links.js、async_fetch.py
...
- Mermaid：7 / 1
- 文件提及重合：app.py、func.py、gc_spider.py、gc_sql.py、xunlei.py
- reference 关键文件未覆盖：config.yaml、compressmkv.py、mergetomkv.py、links.js、async_fetch.py、crawler_config.py、utils.py
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；reference 专题被折叠进非专题页；缺少关键文件提及：config.yaml、compressmkv.py、mergetomkv.py、links.js、async_fetch.py、crawler_config.py、utils.py
...
- Evidence：0 / 1
- Mermaid：5 / 1
- 文件提及重合：news.ts、main.ts、index.ts
- reference 关键文件未覆盖：crawler.ts、globalticker.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：crawler.ts、globalticker.ts
...
- Mermaid：8 / 1
- 文件提及重合：index.ts、news.ts、main.ts
- reference 关键文件未覆盖：package.js、convert.ts、uno.config.ts、vite.config.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；缺少引用/出处块；缺少关键文件提及：package.js、convert.ts、uno.config.ts、vite.config.ts
...
- Mermaid：6 / 1
- 文件提及重合：main.ts、index.ts
- reference 关键文件未覆盖：func.py、output.py、utils.py、convert.ts、globalticker.ts
- 结论：内容明显短于 reference；解释性段落明显不足；章节拆分比 reference 粗；图表少于 reference；evidence block 少于 reference；缺少引用/出处块；缺少关键文件提及：func.py、output.py、utils.py、convert.ts、globalticker.ts
