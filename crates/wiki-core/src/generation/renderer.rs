...
fn prepend_page_cite_block_if_missing(
    draft: &PageDraft,
    page_citations: &[crate::domain::research::SourceCitation],
...
fn collect_page_citations(draft: &PageDraft) -> Vec<crate::domain::research::SourceCitation> {
...
fn render_cite_block(citations: &[crate::domain::research::SourceCitation]) -> String {
...
fn dedup_citation_paths(
    citations: &[crate::domain::research::SourceCitation],
) -> Vec<crate::domain::research::SourceCitation> {
...
fn render_citation_evidence_block(citations: &[crate::domain::research::SourceCitation]) -> String {
...
fn render_section_sources_block(citations: &[crate::domain::research::SourceCitation]) -> String {
    let citations = dedup_citations(citations);
    if citations.is_empty() {
        return String::new();
    }
...
fn render_appendix_entries_block(citations: &[crate::domain::research::SourceCitation]) -> String {
    let citations = dedup_citations(citations);
    if citations.is_empty() {
        return String::new();
    }
...
fn render_diagram_sources_block(citations: &[crate::domain::research::SourceCitation]) -> String {
    let citations = dedup_citation_paths(citations);
    if citations.is_empty() {
        return String::new();
    }
