...
impl SteeringConfig {
    pub fn knowledge_planner_config(&self) -> wiki_knowledge::KnowledgePlannerConfig {
        wiki_knowledge::KnowledgePlannerConfig {
            force_domains: self.knowledge.force_domains.clone(),
            suppress_domains: self.knowledge.suppress_domains.clone(),
            unit_weight_threshold: self.knowledge.unit_weight_threshold,
            max_units_per_domain: self.knowledge.max_units_per_domain,
        }
    }
}
