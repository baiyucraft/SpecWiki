...
use wiki_runtime::workflows::{init::run_init, query::run_query, update::run_update};
...
fn parse_repo_symbols(repo_root: &Path) -> wiki_index::symbols::ParsedSymbolsSnapshot {
